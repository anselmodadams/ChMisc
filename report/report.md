...
Generated at 2026-09-24 16:04:56 (America/Sao_Paulo), covering ClickHouse versions from 1.1.54019 to 26.9.1.1629
...
| `BigQuery` | in v26.8.1.2041 | Yes |
| `Buffer` | in v18.4.0 | Yes |
| `COSN` | in v20.7.2.30 | Yes |
| `CoalescingMergeTree` | in v25.6.1.3206 | Yes |
...
| `LiveView` | in v19.14.3.3 | up to v25.10.7.6 |
| `Log` | in v18.4.0 | Yes |
...
| `Paimon` | in v26.5.1.882 | Yes |
| `PaimonAzure` | in v26.5.1.882 | Yes |
| `PaimonHDFS` | in v26.5.1.882 | Yes |
| `PaimonLocal` | in v26.5.1.882 | Yes |
| `PaimonS3` | in v26.5.1.882 | Yes |
| `PostgreSQL` | in v21.2.2.8 | Yes |
| `QueryRunner` | in v26.7.1.1315 | Yes |
| `RabbitMQ` | in v20.6.3.28 | Yes |
| `Redis` | in v23.6.1.1524 | Yes |
| `Remote` | in v26.7.1.1315 | Yes |
| `RemoteSecure` | in v26.7.1.1315 | Yes |
| `ReplacingMergeTree` | in v18.4.0 | Yes |
| `ReplicatedAggregatingMergeTree` | in v18.4.0 | Yes |
| `ReplicatedCoalescingMergeTree` | in v25.6.1.3206 | Yes |
...
| `View` | in v18.4.0 | Yes |
| `WindowView` | in v21.12.2.17 | up to v26.8.10.6 |
| `YTsaurus` | in v25.8.1.5101 | Yes |
### Table Functions Availability
| Engine | Introduced | Still Available? |
|:-|:-|:-|
| `MeiliSearch` | in v22.5.1.2079 | up to v22.8.21.38 |
| `SQLStandardValues` | in v26.4.1.1141 | Yes |
...
| `eval` | in v26.7.1.1315 | Yes |
| `executable` | in v21.10.2.15 | Yes |
| `file` | in v18.4.0 | Yes |
| `fileCluster` | in v23.11.1.2711 | Yes |
| `filesystem` | in v26.5.1.882 | Yes |
...
| `icebergLocal` | in v24.9.1.3278 | Yes |
| `icebergLocalCluster` | in v26.1.1.912 | Yes |
| `icebergS3` | in v24.9.1.3278 | Yes |
...
| `merge` | in v18.4.0 | Yes |
| `mergeTreeAnalyzeIndexes` | in v26.1.1.912 | Yes |
| `mergeTreeAnalyzeIndexesUUID` | in v26.1.1.912 | Yes |
| `mergeTreeCodecBlockCounts` | in v26.8.1.2041 | Yes |
| `mergeTreeIndex` | in v24.2.1.2248 | Yes |
| `mergeTreeProjection` | in v25.5.1.2782 | Yes |
| `mergeTreeTextIndex` | in v26.3.1.896 | Yes |
...
| `timeSeriesMetricFamilies` | in v26.9.1.1629 | Yes |
| `timeSeriesMetrics` | in v24.8.1.2684 | Yes |
| `timeSeriesSamples` | in v26.6.1.1193 | Yes |
| `timeSeriesSelector` | in v25.8.1.5101 | Yes |
...
| `AvroConfluent` | since v20.3.2.1 | since v26.5.1.882 | in v20.3.2.1 | Yes |
| `BSONEachRow` | since v22.12.1.1752 | since v22.12.1.1752 | in v22.12.1.1752 | Yes |
| `Buffers` | since v25.12.1.649 | since v25.12.1.649 | in v25.12.1.649 | Yes |
...
| `GeoJSON` | since v26.6.1.1193 | since v26.7.1.1315 | in v26.6.1.1193 | Yes |
| `Hash` | (unavailable) | since v25.8.1.5101 | in v25.8.1.5101 | Yes |
| `HiveText` | since v22.1.2.2 | since v26.8.1.2041 | in v22.1.2.2 | Yes |
...
| `JSONL` | since v25.11.1.558 | since v26.6.1.1193 | in v25.11.1.558 | Yes |
...
| `MD` | (unavailable) | since v25.11.1.558 | in v25.11.1.558 | Yes |
...
| `PNG` | (unavailable) | since v26.6.1.1193 | in v26.6.1.1193 | Yes |
...
| `Puffin` | since v26.8.1.2041 | (unavailable) | in v26.8.1.2041 | Yes |
| `PuffinMetadata` | since v26.8.1.2041 | (unavailable) | in v26.8.1.2041 | Yes |
...
| `RowBinaryWithNamesAndTypesAndDefaults` | since v26.6.1.1193 | (unavailable) | in v26.6.1.1193 | Yes |
...
| `GEOMETRY` | No | Geometry | in v22.2.2.1 | Yes |
| `Geometry` | No | (none) | in v25.11.1.558 | Yes |
...
| `MultiPoint` | No | (none) | in v26.8.1.2041 | Yes |
...
| `Object` | No | (none) | in v22.3.2.1 | up to v25.10.7.6 |
...
| `Time` | Yes | (none) | in v25.5.1.2782 | Yes |
| `Time64` | Yes | (none) | in v25.5.1.2782 | Yes |
...
|:-|:-|:-|:-|:-|:-|
| `AIClassify` | No | No | aiClassify | in v26.4.1.1141 | Yes |
| `AIEmbed` | No | No | aiEmbed | in v26.8.1.2041 | Yes |
| `AIExtract` | No | No | aiExtract | in v26.4.1.1141 | Yes |
| `AIFilter` | No | No | aiFilter | in v26.8.1.2041 | Yes |
| `AIGenerate` | No | No | aiGenerate | in v26.4.1.1141 | Yes |
| `AIRedact` | No | No | aiRedact | in v26.8.1.2041 | Yes |
| `AISimilarity` | No | No | aiSimilarity | in v26.8.1.2041 | Yes |
| `AITranslate` | No | No | aiTranslate | in v26.4.1.1141 | Yes |
...
| `CARDINALITY` | No | Yes | length | in v26.5.1.882 | Yes |
...
| `HMAC` | No | Yes | (none) | in v25.12.1.649 | Yes |
...
| `JSONAllValues` | No | No | (none) | in v26.4.1.1141 | Yes |
...
| `JSONExtractArrayRawCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractBool` | No | No | (none) | in v19.8.3.8 | Yes |
| `JSONExtractBoolCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractFloat` | No | No | (none) | in v19.8.3.8 | Yes |
| `JSONExtractFloatCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractInt` | No | No | (none) | in v19.8.3.8 | Yes |
| `JSONExtractIntCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractKeys` | No | No | (none) | in v21.11.2.2 | Yes |
| `JSONExtractKeysAndValues` | No | No | (none) | in v19.8.3.8 | Yes |
| `JSONExtractKeysAndValuesCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractKeysAndValuesRaw` | No | No | (none) | in v20.4.2.9 | Yes |
| `JSONExtractKeysAndValuesRawCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractKeysCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractRaw` | No | No | (none) | in v19.8.3.8 | Yes |
| `JSONExtractRawCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractString` | No | No | (none) | in v19.8.3.8 | Yes |
| `JSONExtractStringCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
| `JSONExtractUInt` | No | No | (none) | in v19.8.3.8 | Yes |
| `JSONExtractUIntCaseInsensitive` | No | No | (none) | in v25.8.1.5101 | Yes |
...
| `L2DistanceTransposedQuantized` | No | No | (none) | in v26.7.1.1315 | Yes |
...
| `MGRSToGeo` | No | No | (none) | in v26.7.1.1315 | Yes |
| `MICROSECOND` | No | Yes | toMicrosecond | in v26.6.1.1193 | Yes |
...
| `MVTBoundingBox` | No | No | (none) | in v26.6.1.1193 | Yes |
| `MVTBoundingBoxMercator` | No | No | (none) | in v26.6.1.1193 | Yes |
| `MVTEncode` | Yes | No | (none) | in v26.6.1.1193 | Yes |
| `MVTEncodeGeom` | No | No | (none) | in v26.6.1.1193 | Yes |
| `NANOSECOND` | No | Yes | toNanosecond | in v26.6.1.1193 | Yes |
| `NATURAL_SORT_KEY` | No | Yes | naturalSortKey | in v26.3.1.896 | Yes |
...
| `REGEXP_SUBSTR` | No | Yes | regexpExtract | in v26.6.1.1193 | Yes |
...
| `STDDEV` | Yes | Yes | stddevSamp | in v26.5.1.882 | Yes |
| `STDDEV_POP` | Yes | Yes | stddevPop | in v1.1.54019 | Yes |
| `STDDEV_SAMP` | Yes | Yes | stddevSamp | in v1.1.54019 | Yes |
| `ST_AsMVT` | Yes | No | MVTEncode | in v26.6.1.1193 | Yes |
| `ST_AsMVTGeom` | No | No | MVTEncodeGeom | in v26.6.1.1193 | Yes |
| `ST_LineFromWKB` | No | No | readWKBLineString | in v25.6.1.3206 | Yes |
| `ST_MLineFromWKB` | No | No | readWKBMultiLineString | in v25.6.1.3206 | Yes |
| `ST_MPointFromWKB` | No | No | readWKBMultiPoint | in v26.8.1.2041 | Yes |
| `ST_MPolyFromWKB` | No | No | readWKBMultiPolygon | in v25.6.1.3206 | Yes |
| `ST_PointFromWKB` | No | No | readWKBPoint | in v25.6.1.3206 | Yes |
| `ST_PolyFromWKB` | No | No | readWKBPolygon | in v25.6.1.3206 | Yes |
...
| `UTMToGeo` | No | No | (none) | in v26.7.1.1315 | Yes |
...
| `WKB` | No | No | wkb | in v25.12.1.649 | Yes |
| `WKT` | No | No | wkt | in v25.12.1.649 | Yes |
| `YEAR` | No | Yes | toYear | in v21.2.2.8 | Yes |
| `YYYYMMDDToDate` | No | Yes | (none) | in v23.9.1.1854 | Yes |
| `YYYYMMDDToDate32` | No | Yes | (none) | in v23.9.1.1854 | Yes |
| `YYYYMMDDhhmmssToDateTime` | No | Yes | (none) | in v23.9.1.1854 | Yes |
...
| `__applyFilter` | No | No | (none) | in v25.12.1.649 | Yes |
...
| `__filterContains` | No | No | (none) | in v25.10.1.3832 | up to v25.11.9.34 |
| `__getScalar` | No | No | (none) | in v19.17.2.4 | Yes |
| `__groupingForCube` | No | No | (none) | in v26.8.1.2041 | Yes |
| `__groupingForGroupingSets` | No | No | (none) | in v26.8.1.2041 | Yes |
| `__groupingForRollup` | No | No | (none) | in v26.8.1.2041 | Yes |
| `__groupingOrdinary` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `__patchPartitionID` | No | No | (none) | in v25.7.1.3997 | Yes |
| `__scalarSubqueryResult` | No | No | (none) | in v24.2.2.71 | Yes |
| `__toYearCalendarOnly` | No | No | (none) | in v26.6.1.1193 | Yes |
...
| `aiClassify` | No | No | (none) | in v26.4.1.1141 | Yes |
| `aiEmbed` | No | No | (none) | in v26.4.5.143 | Yes |
| `aiExtract` | No | No | (none) | in v26.4.1.1141 | Yes |
| `aiFilter` | No | No | (none) | in v26.8.1.2041 | Yes |
| `aiGenerate` | No | No | (none) | in v26.4.1.1141 | Yes |
| `aiRedact` | No | No | (none) | in v26.8.1.2041 | Yes |
| `aiSimilarity` | No | No | (none) | in v26.8.1.2041 | Yes |
| `aiTranslate` | No | No | (none) | in v26.4.1.1141 | Yes |
...
| `areaCartesian` | No | No | (none) | in v25.12.1.649 | Yes |
| `areaSpherical` | No | No | (none) | in v25.12.1.649 | Yes |
| `argAndMax` | Yes | No | (none) | in v25.11.1.558 | Yes |
| `argAndMin` | Yes | No | (none) | in v25.11.1.558 | Yes |
...
| `arrayAutocorrelation` | No | No | (none) | in v26.4.1.1141 | Yes |
| `arrayAvg` | No | No | (none) | in v21.1.2.15 | Yes |
| `arrayBottomK` | No | No | (none) | in v26.6.1.1193 | Yes |
...
| `arrayFlattenedLength` | No | No | (none) | in v26.9.1.1629 | Yes |
...
| `arrayLevenshteinDistance` | No | No | (none) | in v25.4.1.2934 | Yes |
| `arrayLevenshteinDistanceWeighted` | No | No | (none) | in v25.4.1.2934 | Yes |
...
| `arrayRemove` | No | No | (none) | in v25.11.1.558 | Yes |
...
| `arraySimilarity` | No | No | (none) | in v25.4.1.2934 | Yes |
...
| `arrayTopK` | No | No | (none) | in v26.6.1.1193 | Yes |
| `arrayTranspose` | No | No | (none) | in v26.4.1.1141 | Yes |
...
| `array_remove` | No | Yes | arrayRemove | in v25.11.1.558 | Yes |
| `array_to_string` | No | Yes | arrayStringConcat | in v26.5.1.882 | Yes |
| `ascii` | No | Yes | (none) | in v22.11.1.1360 | Yes |
| `asin` | No | Yes | (none) | in v1.1.54019 | Yes |
| `asinh` | No | No | (none) | in v20.12.2.1 | Yes |
| `assignCentroid` | No | No | (none) | in v26.9.1.1629 | Yes |
...
| `authUser` | No | No | authenticatedUser | in v25.3.8.10041.altinitystable | Yes |
| `authenticatedUser` | No | No | (none) | in v25.3.8.10041.altinitystable | Yes |
| `avg` | Yes | Yes | (none) | in v1.1.54019 | Yes |
| `avg2` | No | Yes | (none) | in v25.11.1.558 | Yes |
| `avgWeighted` | Yes | No | (none) | in v20.1.2.4 | Yes |
| `bar` | No | No | (none) | in v1.1.54019 | Yes |
| `base32Decode` | No | No | (none) | in v25.5.1.2782 | Yes |
| `base32Encode` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `bech32Decode` | No | No | (none) | in v25.6.1.3206 | Yes |
| `bech32Encode` | No | No | (none) | in v25.6.1.3206 | Yes |
...
| `caseFoldUTF8` | No | No | (none) | in v26.3.1.896 | Yes |
...
| `catboostEvaluate` | No | No | (none) | in v22.9.1.2603 | up to v26.8.10.6 |
...
| `colorOKLABToSRGB` | No | No | (none) | in v26.2.1.1139 | Yes |
| `colorOKLCHToSRGB` | No | No | (none) | in v25.7.1.3997 | Yes |
| `colorSRGBToOKLAB` | No | No | (none) | in v26.2.1.1139 | Yes |
| `colorSRGBToOKLCH` | No | No | (none) | in v25.7.1.3997 | Yes |
...
| `cosineDistanceTransposed` | No | No | (none) | in v26.1.1.912 | Yes |
| `cosineDistanceTransposedQuantized` | No | No | (none) | in v26.7.1.1315 | Yes |
...
| `cume_dist` | Yes | No | (none) | in v25.11.1.558 | Yes |
| `curdate` | No | Yes | today | in v23.7.1.2470 | Yes |
| `currentDatabase` | No | No | (none) | in v1.1.54019 | Yes |
| `currentHandler` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `currentRequestURL` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `dateTime64ToSnowflake` | No | No | (none) | in v21.10.2.15 | up to v26.6.8.7 |
| `dateTime64ToSnowflakeID` | No | No | (none) | in v24.6.1.4423 | Yes |
| `dateTimeToSnowflake` | No | No | (none) | in v21.10.2.15 | up to v26.6.8.7 |
| `dateTimeToSnowflakeID` | No | No | (none) | in v24.6.1.4423 | Yes |
| `dateTimeToUUIDv7` | No | No | (none) | in v25.8.1.5101 | Yes |
...
| `dequantizeInt8ToBFloat16` | No | No | (none) | in v26.6.1.1193 | Yes |
...
| `detectProgrammingLanguage` | No | No | (none) | in v22.2.2.1 | up to v26.2.19.43 |
...
| `digits` | No | No | (none) | in v26.7.1.1315 | Yes |
| `displayName` | No | No | (none) | in v22.11.1.1360 | Yes |
| `distanceCosine` | No | Yes | cosineDistance | in v26.2.1.1139 | Yes |
| `distanceCosineTransposed` | No | Yes | cosineDistanceTransposed | in v26.1.1.912 | Yes |
...
| `divideOrNull` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `dotProductTransposed` | No | No | (none) | in v26.7.1.1315 | Yes |
| `dotProductTransposedQuantized` | No | No | (none) | in v26.7.1.1315 | Yes |
...
| `financialInternalRateOfReturn` | No | No | (none) | in v25.7.1.3997 | Yes |
| `financialInternalRateOfReturnExtended` | No | No | (none) | in v25.7.1.3997 | Yes |
| `financialNetPresentValue` | No | No | (none) | in v25.7.1.3997 | Yes |
| `financialNetPresentValueExtended` | No | No | (none) | in v25.7.1.3997 | Yes |
...
| `firstNonDefault` | No | Yes | (none) | in v25.3.9.72 | Yes |
...
| `flipCoordinates` | No | No | (none) | in v25.11.1.558 | Yes |
...
| `formatQueryFromJSON` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `fuzzQuery` | No | No | (none) | in v26.2.1.1139 | Yes |
...
| `geoToMGRS` | No | No | (none) | in v26.7.1.1315 | Yes |
| `geoToS2` | No | No | (none) | in v21.9.2.17 | Yes |
| `geoToUTM` | No | No | (none) | in v26.7.1.1315 | Yes |
...
| `geometryIntersectCartesian` | No | No | (none) | in v26.7.1.1315 | Yes |
| `geometryIntersectSpherical` | No | No | (none) | in v26.7.1.1315 | Yes |
...
| `getMergeTreeSetting` | No | No | (none) | in v25.5.1.2782 | Yes |
| `getOSKernelVersion` | No | No | (none) | in v21.11.2.2 | Yes |
| `getServerPort` | No | No | (none) | in v21.10.2.15 | Yes |
| `getServerSetting` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `gini` | Yes | No | (none) | in v26.8.1.2041 | Yes |
...
| `groupFormat` | Yes | No | (none) | in v26.7.1.1315 | Yes |
| `groupNumericIndexedVector` | Yes | No | (none) | in v25.7.1.3997 | Yes |
...
| `h3PolygonToCells` | No | No | (none) | in v25.11.1.558 | Yes |
| `h3PolygonToCellsWithContainment` | No | No | (none) | in v26.6.1.1193 | Yes |
...
| `hasPhrase` | No | No | (none) | in v26.4.1.1141 | Yes |
...
| `hierarchicalKMeans` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `highlight` | No | No | (none) | in v26.4.1.1141 | Yes |
| `highlightQuery` | No | No | (none) | in v26.5.1.882 | Yes |
...
| `icebergBucket` | No | No | (none) | in v25.5.1.2782 | Yes |
| `icebergHash` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `intDivOrNull` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `isDistinctFrom` | No | No | (none) | in v25.11.1.558 | Yes |
...
| `isMergeTreePartCoveredBy` | No | Yes | (none) | in v25.6.1.3206 | Yes |
...
| `isPrime` | No | No | (none) | in v26.5.1.882 | Yes |
| `isProbablePrime` | No | No | (none) | in v26.5.1.882 | Yes |
...
| `kqlBin` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kqlBinAt` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kqlDateTimeBinAt` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kqlDivide` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kqlMultiply` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kqlParameterCast` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kqlRangeCount` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kqlToTimespan` | No | No | (none) | in v26.9.1.1629 | Yes |
| `kql_array_sort_asc` | No | No | (none) | in v23.10.1.1976 | up to v26.5.7.64 |
| `kql_array_sort_desc` | No | No | (none) | in v23.10.1.1976 | up to v26.5.7.64 |
...
| `localtime` | No | Yes | (none) | in v26.6.1.1193 | Yes |
| `localtimestamp` | No | Yes | now | in v26.6.1.1193 | Yes |
...
| `makeDate32` | No | Yes | (none) | in v22.4.1.2305 | Yes |
| `makeDateTime` | No | Yes | (none) | in v22.4.1.2305 | Yes |
| `makeDateTime64` | No | Yes | (none) | in v22.4.1.2305 | Yes |
...
| `mapContains` | No | No | mapContainsKey | in v21.2.2.8 | Yes |
| `mapContainsKey` | No | No | (none) | in v25.6.1.3206 | Yes |
| `mapContainsKeyLike` | No | No | (none) | in v21.11.2.2 | Yes |
| `mapContainsValue` | No | No | (none) | in v25.6.1.3206 | Yes |
| `mapContainsValueLike` | No | No | (none) | in v25.6.1.3206 | Yes |
| `mapExists` | No | No | (none) | in v23.4.1.1943 | Yes |
| `mapExtractKeyLike` | No | No | (none) | in v21.11.2.2 | Yes |
| `mapExtractValueLike` | No | No | (none) | in v25.6.1.3206 | Yes |
...
| `matchCaseInsensitive` | No | No | (none) | in v26.8.1.2041 | Yes |
| `matchPhrase` | No | No | hasPhrase | in v26.4.1.1141 | Yes |
...
| `max_by` | Yes | Yes | argMax | in v26.6.1.1193 | Yes |
...
| `mergeTreePartInfo` | No | Yes | (none) | in v25.6.1.3206 | Yes |
| `mergedJSONPatch` | Yes | No | (none) | in v26.8.1.2041 | Yes |
| `metroHash64` | No | No | (none) | in v1.1.54019 | Yes |
| `mid` | No | Yes | substring | in v18.16.0 | Yes |
| `midpoint` | No | Yes | (none) | in v25.11.1.558 | Yes |
...
| `min_by` | Yes | Yes | argMin | in v26.6.1.1193 | Yes |
...
| `modOrNull` | No | Yes | moduloOrNull | in v25.5.1.2782 | Yes |
...
| `moduloOrNull` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `naiveBayesClassifier` | No | No | (none) | in v25.11.1.558 | Yes |
| `naiveBayesClassifierWithAllProbs` | No | No | (none) | in v26.7.1.1315 | Yes |
| `naiveBayesClassifierWithProb` | No | No | (none) | in v26.7.1.1315 | Yes |
| `naiveBayesNgrams` | No | No | (none) | in v26.7.1.1315 | Yes |
| `naturalSortKey` | No | No | (none) | in v26.3.1.896 | Yes |
...
| `normalizeUTF8NFKCCasefold` | No | No | (none) | in v26.3.1.896 | Yes |
...
| `notHas` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `notMatch` | No | No | (none) | in v26.8.1.2041 | Yes |
| `notMatchCaseInsensitive` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `nowInBlock64` | No | No | (none) | in v25.8.1.5101 | Yes |
...
| `numericIndexedVectorAllValueSum` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorBuild` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorCardinality` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorGetValue` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseAdd` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseDivide` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseEqual` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseGreater` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseGreaterEqual` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseLess` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseLessEqual` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseMultiply` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseNotEqual` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorPointwiseSubtract` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorShortDebugString` | No | No | (none) | in v25.7.1.3997 | Yes |
| `numericIndexedVectorToMap` | No | No | (none) | in v25.7.1.3997 | Yes |
| `obfuscateQuery` | No | No | (none) | in v26.4.2.10 | Yes |
| `obfuscateQueryWithSeed` | No | No | (none) | in v26.4.2.10 | Yes |
...
| `parseISO8601Duration` | No | No | (none) | in v26.9.1.1629 | Yes |
| `parseQueryToJSON` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `perimeterCartesian` | No | No | (none) | in v25.12.1.649 | Yes |
| `perimeterSpherical` | No | No | (none) | in v25.12.1.649 | Yes |
| `pgGetUserById` | No | Yes | (none) | in v26.8.1.2041 | Yes |
| `pgTableIsVisible` | No | Yes | (none) | in v26.8.1.2041 | Yes |
| `pg_get_userbyid` | No | Yes | pgGetUserById | in v26.8.1.2041 | Yes |
| `pg_table_is_visible` | No | Yes | pgTableIsVisible | in v26.8.1.2041 | Yes |
| `pi` | No | Yes | (none) | in v1.1.54019 | Yes |
| `plus` | No | No | (none) | in v1.1.54019 | Yes |
| `pmod` | No | Yes | positiveModulo | in v22.11.1.1360 | Yes |
| `pmodOrNull` | No | Yes | positiveModuloOrNull | in v25.5.1.2782 | Yes |
...
| `polygonsIntersectCartesian` | No | No | (none) | in v25.7.1.3997 | Yes |
| `polygonsIntersectSpherical` | No | No | (none) | in v25.7.1.3997 | Yes |
...
| `positiveModuloOrNull` | No | Yes | (none) | in v25.5.1.2782 | Yes |
| `positive_modulo` | No | Yes | positiveModulo | in v22.11.1.1360 | Yes |
| `positive_modulo_or_null` | No | Yes | positiveModuloOrNull | in v25.5.1.2782 | Yes |
| `pow` | No | Yes | (none) | in v1.1.54019 | Yes |
| `power` | No | Yes | pow | in v18.16.0 | Yes |
| `prettyPrintJSON` | No | No | (none) | in v26.5.1.882 | Yes |
...
| `quantizeBFloat16ToInt8` | No | No | (none) | in v26.6.1.1193 | Yes |
...
| `randomHadamardTransform` | No | No | (none) | in v26.7.1.1315 | Yes |
...
| `readWKB` | No | No | (none) | in v25.12.1.649 | Yes |
| `readWKBLineString` | No | No | (none) | in v25.6.1.3206 | Yes |
| `readWKBMultiLineString` | No | No | (none) | in v25.6.1.3206 | Yes |
| `readWKBMultiPoint` | No | No | (none) | in v26.8.1.2041 | Yes |
| `readWKBMultiPolygon` | No | No | (none) | in v25.6.1.3206 | Yes |
| `readWKBPoint` | No | No | (none) | in v25.6.1.3206 | Yes |
| `readWKBPolygon` | No | No | (none) | in v25.6.1.3206 | Yes |
| `readWKT` | No | No | (none) | in v25.12.1.649 | Yes |
| `readWKTLineString` | No | No | (none) | in v24.6.1.4423 | Yes |
| `readWKTMultiLineString` | No | No | (none) | in v24.8.1.2684 | Yes |
| `readWKTMultiPoint` | No | No | (none) | in v26.8.1.2041 | Yes |
...
| `readWkb` | No | No | readWKB | in v25.11.1.558 | Yes |
| `readWkt` | No | No | readWKT | in v25.11.1.558 | Yes |
...
| `regexpInstr` | No | Yes | regexpPosition | in v26.5.1.882 | Yes |
| `regexpPosition` | No | No | (none) | in v26.5.1.882 | Yes |
| `regexpQuoteMeta` | No | No | (none) | in v19.1.5 | Yes |
| `regexp_instr` | No | Yes | regexpPosition | in v26.5.1.882 | Yes |
...
| `regr_avgx` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_avgy` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_count` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_intercept` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_r2` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_slope` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_sxx` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_sxy` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
| `regr_syy` | Yes | Yes | (none) | in v26.9.1.1629 | Yes |
...
| `removeAccentsUTF8` | No | No | removeDiacriticsUTF8 | in v26.3.1.896 | Yes |
| `removeDiacriticsUTF8` | No | No | (none) | in v26.3.1.896 | Yes |
...
| `reverseBySeparator` | No | No | (none) | in v26.1.1.912 | Yes |
...
| `scalarProductTransposed` | No | Yes | dotProductTransposed | in v26.7.1.1315 | Yes |
| `searchAll` | No | No | (none) | in v25.7.1.3997 | up to v25.9.7.56 |
| `searchAny` | No | No | (none) | in v25.7.1.3997 | up to v25.9.7.56 |
...
| `session_user` | No | Yes | currentUser | in v26.6.1.1193 | Yes |
...
| `snowflakeToDateTime` | No | No | (none) | in v21.10.2.15 | up to v26.6.8.7 |
| `snowflakeToDateTime64` | No | No | (none) | in v21.10.2.15 | up to v26.6.8.7 |
...
| `sparseGrams` | No | No | (none) | in v25.4.1.2934 | Yes |
| `sparseGramsHashes` | No | No | (none) | in v25.4.1.2934 | Yes |
| `sparseGramsHashesUTF8` | No | No | (none) | in v25.4.1.2934 | Yes |
| `sparseGramsUTF8` | No | No | (none) | in v25.4.1.2934 | Yes |
...
| `sqr` | No | Yes | (none) | in v26.7.1.1315 | Yes |
...
| `stringBytesEntropy` | No | No | (none) | in v25.5.1.2782 | Yes |
| `stringBytesUniq` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `string_agg` | Yes | Yes | groupConcat | in v26.5.1.882 | Yes |
...
| `timeSeriesAvgToGrid` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesBottomKMasks` | Yes | No | (none) | in v26.8.1.2041 | Yes |
| `timeSeriesChangesToGrid` | Yes | No | (none) | in v25.9.2.1 | Yes |
| `timeSeriesCopyTag` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesCopyTags` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesCountToGrid` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesDeltaToGrid` | Yes | No | (none) | in v25.6.1.3206 | Yes |
| `timeSeriesDerivToGrid` | Yes | No | (none) | in v25.8.1.5101 | Yes |
| `timeSeriesExtractTag` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesFromGrid` | No | No | (none) | in v25.8.1.5101 | Yes |
| `timeSeriesGroupArray` | Yes | No | (none) | in v25.8.1.5101 | Yes |
...
| `timeSeriesGroupToSamplingKey` | No | No | (none) | in v26.4.1.1141 | Yes |
| `timeSeriesGroupToTags` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesIdToGroup` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesIdToTags` | No | No | (none) | in v25.8.1.5101 | Yes |
| `timeSeriesIdToTagsGroup` | No | No | timeSeriesIdToGroup | in v25.8.1.5101 | Yes |
| `timeSeriesIncreaseToGrid` | Yes | No | (none) | in v26.7.1.1315 | Yes |
| `timeSeriesInstantDeltaToGrid` | Yes | No | (none) | in v25.6.1.3206 | Yes |
| `timeSeriesInstantRateToGrid` | Yes | No | (none) | in v25.6.1.3206 | Yes |
| `timeSeriesJoinTags` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesLastToGrid` | Yes | No | timeSeriesResampleToGridWithStaleness | in v25.8.1.5101 | Yes |
| `timeSeriesLastTwoSamples` | Yes | No | (none) | in v25.6.1.3206 | Yes |
| `timeSeriesLimitKMasks` | Yes | No | (none) | in v26.8.1.2041 | Yes |
| `timeSeriesMaxToGrid` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesMetricTypeToSuffixes` | No | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesMinToGrid` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesPredictLinearToGrid` | Yes | No | (none) | in v25.8.1.5101 | Yes |
| `timeSeriesPrometheusValueToString` | No | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesRange` | No | No | (none) | in v25.8.1.5101 | Yes |
| `timeSeriesRateToGrid` | Yes | No | (none) | in v25.6.1.3206 | Yes |
| `timeSeriesRemoveAllTagsExcept` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesRemoveTag` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesRemoveTags` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesReplaceTag` | No | No | (none) | in v26.1.1.912 | Yes |
...
| `timeSeriesSumToGrid` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesTagsGroupToTags` | No | No | timeSeriesGroupToTags | in v25.8.1.5101 | Yes |
| `timeSeriesTagsToGroup` | No | No | (none) | in v26.1.1.912 | Yes |
| `timeSeriesTagsToMap` | No | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesThrowDuplicateSeriesIf` | No | No | (none) | in v26.2.1.1139 | Yes |
| `timeSeriesTimestampOfMaxToGrid` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesTimestampOfMinToGrid` | Yes | No | (none) | in v26.9.1.1629 | Yes |
| `timeSeriesTopKMasks` | Yes | No | (none) | in v26.8.1.2041 | Yes |
| `timeSlot` | No | No | (none) | in v1.1.54019 | Yes |
| `timeSlots` | No | No | (none) | in v1.1.54019 | Yes |
| `timeZone` | No | Yes | timezone | in v21.4.3.21 | Yes |
...
| `timestamp_diff` | No | No | dateDiff | in v23.4.1.1943 | Yes |
| `timezone` | No | Yes | (none) | in v1.1.54140 | Yes |
...
| `toDaysInMonth` | No | No | (none) | in v26.3.1.896 | Yes |
...
| `toInterval` | No | No | (none) | in v25.4.1.2934 | Yes |
...
| `toMicrosecond` | No | No | (none) | in v26.6.1.1193 | Yes |
...
| `toNanosecond` | No | No | (none) | in v26.6.1.1193 | Yes |
...
| `toTime64` | No | No | (none) | in v25.5.1.2782 | Yes |
| `toTime64OrNull` | No | No | (none) | in v25.5.1.2782 | Yes |
| `toTime64OrZero` | No | No | (none) | in v25.5.1.2782 | Yes |
| `toTimeOrNull` | No | No | (none) | in v25.5.1.2782 | Yes |
| `toTimeOrZero` | No | No | (none) | in v25.5.1.2782 | Yes |
| `toTimeWithFixedDate` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `today` | No | Yes | (none) | in v1.1.54019 | Yes |
| `tokenizeQuery` | No | No | (none) | in v26.5.1.882 | Yes |
| `tokens` | No | No | (none) | in v21.11.2.2 | Yes |
| `tokensForLikePattern` | No | No | (none) | in v26.3.1.896 | Yes |
...
| `tryBase32Decode` | No | No | (none) | in v25.5.1.2782 | Yes |
...
| `tuplePositiveModuloByNumber` | No | No | (none) | in v26.4.1.1141 | Yes |
...
| `unnest` | No | Yes | arrayJoin | in v26.5.1.882 | Yes |
...
| `windowID` | No | No | (none) | in v22.1.2.2 | up to v26.8.10.6 |
| `wkb` | No | No | (none) | in v25.7.1.3997 | Yes |
...
| `xxHash64Spark` | No | No | (none) | in v26.7.1.1315 | Yes |
| `xxh3` | No | No | (none) | in v22.12.1.1752 | Yes |
| `xxh3_128` | No | No | (none) | in v26.2.1.1139 | Yes |
...
|:-|:-|:-|:-|:-|
| `adaptive_aggregator_freeze_threshold` | in v26.8.1.2041 |  | Yes | The number of keys at which the adaptive aggregator freezes a thread\'s local hash table (see `enable_adaptive_aggregator`). Smaller values keep the frozen tables cache-resident, larger values let them absorb more of the frequent keys. 0 freezes the tables at the first opportunity, which makes the algorithm behave similarly to the sharded aggregator (`enable_sharding_aggregator`): every key is routed by its hash and aggregated by a single owner, just deferred to the merge phase instead of exchanged between threads during the scan. |
| `adaptive_aggregator_freeze_threshold_bytes` | in v26.8.1.2041 |  | Yes | The memory size at which the adaptive aggregator freezes a thread\'s local hash table (see `enable_adaptive_aggregator`). A table freezes at whichever of this and `adaptive_aggregator_freeze_threshold` is reached first. The size is the local table\'s own allocated bytes (its hash-table buffer plus its arenas), checked between blocks. The byte bound matters when the keys or the aggregation states are wide: the key-count threshold alone would let such tables outgrow the CPU caches. At the default, tables of ordinary key and state widths keep freezing by the key count. 0 disables the byte bound, so the key-count threshold alone decides. |
...
| `ai_function_allow_insecure_endpoint` | in v26.8.1.2041 |  | Yes | If false (default), AI functions refuse to use a named-collection `endpoint` that would send prompts and API keys over an unencrypted connection to a remote host: any non-HTTPS endpoint whose host is not loopback is rejected with an exception. Loopback endpoints (e.g. a local `http://localhost` model server) are always allowed. Set to true to permit plaintext `http://` endpoints on remote hosts. |
| `ai_function_credentials` | in v26.6.1.1193 |  | up to v26.6.2.81 | Name of the named collection that AI functions use for provider credentials and configuration (`provider`, `endpoint`, `model`, optional `api_key`, etc.). When empty, an exception is raised. |
| `ai_function_embedding_default_credentials` | in v26.5.6.113 |  | Yes | Name of the named collection used by `aiEmbed` when the call does not pass `credentials` in its parameter map. Empty means no default: such calls must pass `credentials` explicitly. `aiEmbed` takes `model` as a required positional argument, not from the named collection. Kept separate from `ai_function_text_default_credentials` because an embeddings endpoint differs from a chat one. |
| `ai_function_embedding_max_batch_size` | in v26.4.5.143 |  | Yes | Maximum number of texts to include in a single HTTP request made by `aiEmbed`. Texts are grouped into batches of this size to reduce API call overhead. For example, 500 unique texts with a batch size of 100 result in 5 HTTP requests. |
| `ai_function_max_api_calls_per_query` | in v26.4.1.1141 |  | Yes | Maximum number of HTTP requests that AI functions may dispatch per query. Set to 0 to disable. |
| `ai_function_max_input_tokens_per_query` | in v26.4.1.1141 |  | Yes | Maximum total input (prompt) tokens across all AI function API calls in a single query. Tracked cumulatively from provider responses. Note that this limit may be exceeded by one call\'s worth of input tokens, since the number of input tokens of a call are not known in advance. Set to 0 to disable. |
| `ai_function_max_output_tokens_per_query` | in v26.4.1.1141 |  | Yes | Maximum total output (completion) tokens across all AI function API calls in a single query. Tracked cumulatively from provider responses. Note that this limit may be exceeded by one call\'s worth of output tokens, since the number of output tokens of a call are not known in advance. Set to 0 to disable. |
| `ai_function_max_retries` | in v26.4.1.1141 |  | Yes | Maximum number of retry attempts for transient errors per individual API request. Each retry uses exponential backoff starting from `ai_function_retry_initial_delay_ms`. |
| `ai_function_request_timeout_sec` | in v26.4.1.1141 |  | Yes | Timeout in seconds for individual HTTP requests made by AI functions (AI chat completions and embedding API calls). If a request does not complete within this time, it is considered failed and may be retried according to `ai_function_max_retries`. |
| `ai_function_retry_initial_delay_ms` | in v26.4.1.1141 |  | Yes | Initial delay in milliseconds before the first retry of a failed AI function API request. The delay doubles on each subsequent attempt (exponential backoff). For example, with default settings: 1000ms, 2000ms, 4000ms. |
| `ai_function_text_default_credentials` | in v26.5.6.113 |  | Yes | Name of the named collection used by the text AI functions (`aiGenerate`, `aiClassify`, `aiExtract`, `aiTranslate`) when the call does not pass `credentials` in its parameter map. Empty means no default: such calls must pass `credentials` explicitly. A chat-completions endpoint differs from an embeddings one, so this is separate from `ai_function_embedding_default_credentials`. |
| `ai_function_throw_on_error` | in v26.4.1.1141 |  | Yes | If true (default), an AI function call that fails permanently after exhausting all retries aborts the query with an exception. If false, the failed row receives the default value for the column type (empty string for String) and processing continues. |
| `ai_function_throw_on_quota_exceeded` | in v26.4.1.1141 |  | Yes | If true (default), exceeding an AI function quota limit (`ai_function_max_input_tokens_per_query`, `ai_function_max_output_tokens_per_query`, or `ai_function_max_api_calls_per_query`) aborts the query with an exception. If false, remaining rows receive the default value for the column type (empty string for String). |
...
| `allow_calculating_subcolumns_sizes_for_merge_tree_reading` | in v26.3.1.896 |  | Yes | When enabled, ClickHouse will calculate the size of files required for each subcolumn reading for better task and block sizes calculation. |
...
| `allow_correlated_subqueries` | in v26.9.1.1629 |  | Yes | Allow to execute correlated subqueries. |
...
| `allow_database_glue_catalog` | in v25.8.1.5101 |  | Yes | Allow experimental database engine DataLakeCatalog with catalog_type = \'glue\' |
| `allow_database_iceberg` | in v25.8.1.5101 |  | Yes | Allow experimental database engine DataLakeCatalog with catalog_type = \'iceberg\' |
| `allow_database_unity_catalog` | in v25.8.1.5101 |  | Yes | Allow experimental database engine DataLakeCatalog with catalog_type = \'unity\' |
| `allow_ddl` | in v18.12.14 |  | Yes | If it is set to true, then a user is allowed to executed DDL queries. |
| `allow_delta_kernel_rs` | in v26.8.1.2041 |  | Yes | Allow the `delta-kernel-rs` implementation for reading Delta Lake tables. |
| `allow_delta_lake_create_table` | in v26.9.1.1629 |  | Yes | Allow creating a new DeltaLake table using delta-kernel-rs or registering an existing one into a catalog. Creating a partitioned table (`PARTITION BY`) is not supported yet. In a `DataLakeCatalog` database the table is registered with its Delta schema, so declared ClickHouse types that map to a wider Delta type (e.g. `UInt8` -> `short`, `FixedString(N)` -> `string`) are read back as the Delta-mapped type rather than the declared one. |
| `allow_delta_lake_writes` | in v26.7.1.1315 |  | Yes | Enables delta-kernel writes feature. |
...
| `allow_deprecated_snowflake_conversion_functions` | in v24.6.1.4423 | in v26.7.1.1315 | Yes | Enables deprecated functions snowflakeToDateTime[64] and dateTime[64]ToSnowflake. |
...
| `allow_distinct_partitions_independently` | in v26.8.1.2041 |  | Yes | Enable independent `DISTINCT` evaluation per partition on separate threads when the partition expression is a deterministic function of the `DISTINCT` columns, skipping the cross-stream merge. Beneficial when the number of partitions is close to the number of cores and partitions have roughly the same size; otherwise a cost heuristic skips it, see [max_number_of_partitions_for_independent_distinct](#max_number_of_partitions_for_independent_distinct) and [force_distinct_partitions_independently](#force_distinct_partitions_independently). Not applied with `FINAL` or parallel replicas.\n\nNot applied when [max_rows_in_distinct](#max_rows_in_distinct) or [max_bytes_in_distinct](#max_bytes_in_distinct) is set: those limits are enforced by the single `DISTINCT` transform that sees the whole merged result, so the cross-stream merge is kept to preserve their global meaning. |
...
| `allow_experimental_ai_functions` | in v26.4.1.1141 | in v26.8.3.105 | Yes | Enable experimental AI functions (e.g. `aiGenerateContent`). These functions make external HTTP calls to AI providers. |
| `allow_experimental_alias_table_engine` | in v25.10.3.100 | in v26.5.1.882 | Yes | Allow to create table with the Alias engine. |
...
| `allow_experimental_cleanup_old_data_files_compaction` | in v26.5.1.882 |  | Yes | Allow to clean up old data files during Iceberg compaction. |
| `allow_experimental_codecs` | in v21.7.2.7 | in v26.9.1.1629 | Yes | If it is set to true, allow to specify experimental compression codecs (but we don\'t have those yet and this option does nothing). |
| `allow_experimental_correlated_subqueries` | in v25.4.1.2934 |  | Yes | Allow to execute correlated subqueries. |
...
| `allow_experimental_database_hms_catalog` | in v25.5.1.2782 |  | Yes | Allow experimental database engine DataLakeCatalog with catalog_type = \'hms\' |
...
| `allow_experimental_database_paimon_rest_catalog` | in v26.1.1.912 |  | Yes | Allow experimental database engine DataLakeCatalog with catalog_type = \'paimon_rest\' |
...
| `allow_experimental_delta_kernel_rs` | in v25.5.1.2782 |  | Yes | Allow experimental delta-kernel-rs implementation. |
| `allow_experimental_delta_lake_writes` | in v25.8.2.29 |  | Yes | Enables delta-kernel writes feature. |
| `allow_experimental_dynamic_type` | in v24.5.1.1763 | in v25.8.1.5101 | Yes | Allow Dynamic data type |
| `allow_experimental_eval_table_function` | in v26.7.1.1315 |  | Yes | Enable experimental table function `eval`. |
| `allow_experimental_expire_snapshots` | in v26.3.1.896 |  | Yes | Allow to execute experimental Iceberg command `ALTER TABLE ... EXECUTE expire_snapshots`. |
...
| `allow_experimental_geo_types_in_iceberg` | in v26.5.1.882 |  | Yes | Allow parsing Iceberg `geometry` and `geography` field types as ClickHouse `Geometry` (Variant) type. |
| `allow_experimental_hash_functions` | in v22.6.1.1985 |  | Yes | Enable experimental hash functions (hashid, etc) |
| `allow_experimental_iceberg_compaction` | in v25.8.1.5101 |  | Yes | Allow to explicitly use \'OPTIMIZE\' for iceberg tables. |
| `allow_experimental_insert_into_iceberg` | in v25.7.1.3997 |  | Yes | Allow to execute `insert` queries into iceberg. |
| `allow_experimental_inverted_index` | in v23.1.1.3077 | in v25.7.1.3997 | Yes | If it is set to true, allow to use experimental inverted index. |
| `allow_experimental_join_condition` | in v24.5.1.1763 | in v25.7.1.3997 | Yes | Support join with inequal conditions which involve columns from both left and right table. e.g. t1.y < t2.y. |
...
| `allow_experimental_json_lazy_type_hints` | in v26.3.1.896 |  | Yes | Enable experimental lazy type hints for JSON type. This feature allows optimizing JSON type conversions by deferring type hint evaluation. |
| `allow_experimental_json_type` | in v24.8.1.2684 | in v25.8.1.5101 | Yes | Allow JSON data type |
...
| `allow_experimental_lightweight_update` | in v25.5.1.2782 |  | Yes | Allow to use lightweight updates. |
| `allow_experimental_live_view` | in v19.14.3.3 | in v25.11.1.558 | Yes | Enable LIVE VIEW. Not mature enough. |
...
| `allow_experimental_nullable_tuple_type` | in v26.1.1.912 |  | Yes | Allows creation of [Nullable](../../sql-reference/data-types/nullable) [Tuple](../../sql-reference/data-types/tuple.md) columns in tables. |
| `allow_experimental_object_storage_queue_hive_partitioning` | in v26.1.1.912 |  | Yes | Allow to use hive partitioning with S3Queue/AzureQueue engines\n     |
| `allow_experimental_object_type` | in v22.3.2.1 | in v25.11.1.558 | Yes | Allow Object and JSON data types |
| `allow_experimental_paimon_storage_engine` | in v26.5.1.882 |  | Yes | Allow to create tables with Paimon* table engines. |
...
| `allow_experimental_polyglot_dialect` | in v26.3.1.896 |  | Yes | Enable polyglot SQL transpiler - transpiles SQL from 30+ dialects (MySQL, PostgreSQL, SQLite, Snowflake, DuckDB, etc.) into ClickHouse SQL. |
...
| `allow_experimental_qbit_type` | in v25.10.1.3832 | in v26.2.1.1139 | Yes | Allows creation of [QBit](../../sql-reference/data-types/qbit.md) data type. |
| `allow_experimental_query_cache` | in v23.2.1.2537 | in v23.5.1.3174 | Yes | Enable experimental query cache |
| `allow_experimental_query_deduplication` | in v21.3.2.5 | in v26.6.1.1193 | Yes | Allow sending parts\' UUIDs for a query in order to deduplicate data parts if any |
...
| `allow_experimental_shared_set_join` | in v24.10.1.2812 | in v25.4.1.2934 | Yes | Only in ClickHouse Cloud. Allow to create ShareSet and SharedJoin |
| `allow_experimental_statistic` | in v23.11.1.2711 | in v26.3.1.896 | Yes | Allows using statistic |
| `allow_experimental_statistics` | in v24.6.1.4423 |  | Yes | Allows using statistics |
| `allow_experimental_text_index_lazy_apply` | in v26.6.1.1193 | in v26.7.1.1315 | Yes | If set to true, allow using the lazy posting list apply mode for text index queries. |
| `allow_experimental_time_series_aggregate_functions` | in v25.6.1.3206 |  | Yes | Experimental timeSeries* aggregate functions for Prometheus-like timeseries resampling, rate, delta calculation. |
| `allow_experimental_time_series_table` | in v24.8.1.2684 |  | Yes | Allows experimental TimeSeries table engine |
| `allow_experimental_time_time64_type` | in v25.6.1.3206 |  | Yes | Allows creation of [Time](../../sql-reference/data-types/time.md) and [Time64](../../sql-reference/data-types/time64.md) data types. |
...
| `allow_experimental_unique_key` | in v26.5.1.882 |  | Yes | Allows creation of tables with the `UNIQUE KEY` clause on MergeTree-family engines. |
| `allow_experimental_url_wildcard_from_index_pages` | in v26.7.1.1315 |  | Yes | Allow experimental wildcard expansion for `url()` and `ENGINE = URL` from HTTP index pages. |
...
| `allow_experimental_variant_type` | in v24.1.1.2048 | in v25.8.1.5101 | Yes | Allow Variant data type |
| `allow_experimental_vector_similarity_index` | in v24.8.1.2684 | in v25.8.1.5101 | Yes | Allow experimental vector similarity index |
| `allow_experimental_window_functions` | in v21.1.2.15 | in v21.9.2.17 | Yes | Allow experimental window functions |
| `allow_experimental_window_view` | in v21.12.2.17 | in v26.9.1.1629 | Yes | Enable WINDOW VIEW. Not mature enough. |
| `allow_experimental_ytsaurus_dictionary_source` | in v25.8.1.5101 |  | Yes |     Experimental dictionary source for integration with YTsaurus.\n     |
| `allow_experimental_ytsaurus_table_engine` | in v25.8.1.5101 |  | Yes | Experimental table engine for integration with YTsaurus. |
| `allow_experimental_ytsaurus_table_function` | in v25.8.1.5101 |  | Yes | Experimental table engine for integration with YTsaurus. |
| `allow_fuzz_query_functions` | in v26.2.1.1139 |  | Yes | Enables the `fuzzQuery` function that applies random AST mutations to a query string. |
...
| `allow_geo_types_in_iceberg` | in v26.9.1.1629 |  | Yes | Allow parsing Iceberg `geometry` and `geography` field types as ClickHouse `Geometry` (Variant) type. |
...
| `allow_iceberg_remove_orphan_files` | in v26.4.1.1141 |  | Yes | Allow to use \'ALTER TABLE ... EXECUTE remove_orphan_files()\' for iceberg tables. |
| `allow_insert_into_iceberg` | in v26.2.1.1139 |  | Yes | Allow to execute `insert` queries into iceberg. |
...
| `allow_metadata_only_named_tuple_alter` | in v26.8.1.2041 |  | Yes | If true, ALTER MODIFY COLUMN on a named Tuple that only adds new subfields is metadata-only (no data mutation).\nSet to false to force the old full-mutation behavior. |
| `allow_minmax_index_for_json` | in v26.7.1.1315 |  | Yes | Allow creating minmax skip indexes on JSON (Object) columns. Disabled by default because the minmax\nindex serialization path cannot handle heterogeneous Field values that JSON columns may contain. |
...
| `allow_statistics` | in v26.3.1.896 |  | Yes | Allows defining columns with [statistics](../../engines/table-engines/mergetree-family/mergetree.md/#table_engine-mergetree-creating-a-table) and [manipulate statistics](../../engines/table-engines/mergetree-family/mergetree.md/#column-statistics). |
...
| `archive_adaptive_buffer_max_size_bytes` | in v26.1.1.912 |  | Yes | Limits the maximum size of the adaptive buffer used when writing to archive files (for example, tar archives |
| `arrow_flight_request_descriptor_type` | in v25.11.1.558 |  | Yes | Type of descriptor to use for Arrow Flight requests. \'path\' sends the dataset name as a path descriptor. \'command\' sends a SQL query as a command descriptor (required for Dremio).\n\nPossible values:\n- \'path\' — Use FlightDescriptor::Path (default, works with most Arrow Flight servers)\n- \'command\' — Use FlightDescriptor::Command with a SELECT query (required for Dremio) |
| `ast_fuzzer_any_query` | in v26.2.1.1139 |  | Yes | When false (default), the server-side AST fuzzer (controlled by `ast_fuzzer_runs`) only fuzzes read-only queries (SELECT, EXPLAIN, SHOW, DESCRIBE, EXISTS). When true, all query types including DDL and INSERT are fuzzed. |
| `ast_fuzzer_oracle` | in v26.9.1.1629 |  | Yes | When enabled together with `ast_fuzzer_runs`, applies a suite of correctness oracle checks to successfully executed fuzzed SELECT queries: TLP WHERE/DISTINCT/GROUP BY/HAVING/Aggregate, NoREC, DQP (toggling individual optimizer settings), Identity WHERE, and Subquery wrap. A mismatch throws an `AST_FUZZER_ORACLE_MISMATCH` exception. |
| `ast_fuzzer_runs` | in v26.2.1.1139 |  | Yes | Enables the server-side AST fuzzer that runs randomized queries after each normal query, discarding their results.\n- 0: disabled (default).\n- A value between 0 and 1 (exclusive): probability of running a single fuzzed query.\n- A value >= 1: the number of fuzzed queries to run per normal query.\n\nThe fuzzer accumulates AST fragments from all queries across all sessions, producing increasingly interesting mutations over time. Fuzzed queries that fail are silently discarded; results are never returned to the client. |
...
| `asterisk_include_virtual_columns` | in v26.4.1.1141 |  | Yes | Include virtual columns for wildcard query (`SELECT *`).\n\nPossible values:\n\n- 0 - disabled\n- 1 - enabled |
...
| `azure_connect_timeout_ms` | in v25.8.1.5101 |  | Yes | Connection timeout for host from azure disks. |
...
| `azure_max_get_burst` | in v25.8.1.5101 |  | Yes | Max number of requests that can be issued simultaneously before hitting request per second limit. By default (0) equals to `azure_max_get_rps` |
| `azure_max_get_rps` | in v25.8.1.5101 |  | Yes | Limit on Azure GET request per second rate before throttling. Zero means unlimited. |
...
| `azure_max_put_burst` | in v25.8.1.5101 |  | Yes | Max number of requests that can be issued simultaneously before hitting request per second limit. By default (0) equals to `azure_max_put_rps` |
| `azure_max_put_rps` | in v25.8.1.5101 |  | Yes | Limit on Azure PUT request per second rate before throttling. Zero means unlimited. |
| `azure_max_redirects` | in v25.8.1.5101 |  | Yes | Max number of azure redirects hops allowed. |
...
| `azure_request_timeout_ms` | in v25.8.1.5101 |  | Yes | Idleness timeout for sending and receiving data to/from azure. Fail if a single TCP read or write call blocks for this long. |
...
| `azure_sdk_use_native_client` | in v25.8.1.5101 | in v25.11.1.558 | Yes | Use clickhouse native HTTP client for Azure SDK. |
...
| `azure_use_adaptive_timeouts` | in v25.8.1.5101 |  | Yes | When set to `true` than for all azure requests first two attempts are made with low send and receive timeouts.\nWhen set to `false` than all attempts are made with identical timeouts. |
...
| `backup_restore_s3_retry_initial_backoff_ms` | in v25.8.1.5101 |  | Yes |     Initial backoff delay in milliseconds before the first retry attempt during backup and restore. Each subsequent retry increases the delay exponentially, up to the maximum specified by `backup_restore_s3_retry_max_backoff_ms` |
| `backup_restore_s3_retry_jitter_factor` | in v25.8.1.5101 |  | Yes |     Jitter factor applied to the retry backoff delay in Aws::Client::RetryStrategy during backup and restore operations. The computed backoff delay is multiplied by a random factor in the range [1.0, 1.0 + jitter], up to the maximum `backup_restore_s3_retry_max_backoff_ms`. Must be in [0.0, 1.0] interval |
| `backup_restore_s3_retry_max_backoff_ms` | in v25.8.1.5101 |  | Yes |     Maximum delay in milliseconds between retries during backup and restore operations. |
| `backup_slow_all_threads_after_retryable_s3_error` | in v25.6.8.10 |  | Yes | When set to `true`, all threads executing S3 requests to the same backup endpoint are slowed down\nafter any single S3 request encounters a retryable S3 error, such as \'Slow Down\'.\nWhen set to `false`, each thread handles s3 request backoff independently of the others. |
...
| `cascades_aggregation_pushdown` | in v26.9.1.1629 |  | Yes | Consider pushing partial aggregation below a join (eager aggregation) as a cost-based alternative in the Cascades optimizer.\nTakes effect only together with `enable_cascades_optimizer = 1` and `make_distributed_plan = 1`. |
...
| `cast_string_to_date_time_mode` | in v25.6.1.3206 |  | Yes | Allows choosing a parser of the text representation of date and time during cast from String.\n\nPossible values:\n\n- `\'best_effort\'` — Enables extended parsing.\n\n    ClickHouse can parse the basic `YYYY-MM-DD HH:MM:SS` format and all [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time formats. For example, `\'2018-06-08T01:02:03.000Z\'`.\n\n- `\'best_effort_us\'` — Similar to `best_effort` (see the difference in [parseDateTimeBestEffortUS](../../sql-reference/functions/type-conversion-functions#parsedatetimebesteffortus)\n\n- `\'basic\'` — Use basic parser.\n\n    ClickHouse can parse only the basic `YYYY-MM-DD HH:MM:SS` or `YYYY-MM-DD` format. For example, `2019-08-20 10:18:56` or `2019-08-20`.\n\nSee also:\n\n- [DateTime data type.](../../sql-reference/data-types/datetime.md)\n- [Functions for working with dates and times.](../../sql-reference/functions/date-time-functions.md) |
| `cast_string_to_dynamic_use_inference` | in v24.5.1.1763 |  | Yes | Use types inference during String to Dynamic conversion |
| `cast_string_to_variant_use_inference` | in v25.4.1.2934 |  | Yes | Use types inference during String to Variant conversion. |
| `check_conversion_from_numbers_to_enum` | in v26.1.1.912 |  | Yes | Throw an exception during Numbers to Enum conversion if the value does not exist in Enum.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled.\n\n**Example**\n\n```text\nCREATE TABLE tab (\n  val Enum(\'first\' = 1, \'second\' = 2, \'third\' = 3)\n) ENGINE = Memory;\n\nINSERT INTO tab SETTINGS check_conversion_from_numbers_to_enum = 1 VALUES (4); -- returns an error\n``` |
| `check_named_collection_dependencies` | in v26.2.1.1139 |  | Yes | Check that DROP NAMED COLLECTION will not break tables that depend on it |
...
| `cloud_mode_database_engine` | in v24.10.1.2812 | in v26.7.1.1315 | Yes | The database engine allowed in Cloud. 1 - rewrite DDLs to use Replicated database, 2 - rewrite DDLs to use Shared database |
...
| `compatibility_s3_presigned_url_query_in_path` | in v25.12.1.649 |  | Yes | Compatibility: when enabled, folds pre-signed URL query parameters (e.g. X-Amz-*) into the S3 key (legacy behavior),\nso \'?\' acts as a wildcard in the path. When disabled (default), pre-signed URL query parameters are kept in the URL query\nto avoid interpreting \'?\' as a wildcard. |
...
| `compile_regular_expressions` | in v26.7.1.1315 |  | Yes | Compile simple regular expressions used in functions like `match` and `extract` to native code. Patterns outside the supported subset transparently fall back to the general engine. |
...
| `correlated_subqueries_use_in_memory_buffer` | in v26.1.1.912 |  | Yes | Use in-memory buffer for correlated subquery input to avoid its repeated evaluation. |
...
| `count_matches_stop_at_empty_match` | in v25.6.1.3206 |  | Yes | Stop counting once a pattern matches zero-length in the `countMatches` function. |
...
| `database_datalake_require_metadata_access` | in v26.1.1.912 |  | Yes | Either to throw error or not if we don\'t have rights to get table\'s metadata in database engine DataLakeCatalog. |
...
| `database_shared_drop_table_delay_seconds` | in v25.11.1.558 |  | Yes | The delay in seconds before a dropped table is actually removed from a Shared database. This allows to recover the table within this time using `UNDROP TABLE` statement. |
...
| `dead_blobs_to_delay_insert` | in v26.7.1.1315 |  | Yes | If the dead blobs queues of the destination table\'s disks contain at least that many blobs pending removal, artificially slow down insert into table. 0 - use the table setting. |
| `dead_blobs_to_throw_insert` | in v26.7.1.1315 |  | Yes | If the dead blobs queues of the destination table\'s disks contain more than this number of blobs pending removal, throw \'Too many dead blobs ...\' exception. 0 - use the table setting. |
...
| `delta_lake_reload_schema_for_consistency` | in v26.2.1.1139 |  | Yes | If enabled, schema is reloaded from the DeltaLake metadata before each query execution to ensure\nconsistency between the schema used during query analysis and the schema used during execution. |
| `delta_lake_snapshot_end_version` | in v25.12.1.649 |  | Yes | End version of delta lake snapshot to read. Value -1 means to read latest version (value 0 is a valid snapshot version). |
| `delta_lake_snapshot_start_version` | in v25.12.1.649 |  | Yes | Start version of delta lake snapshot to read. Value -1 means to read latest version (value 0 is a valid snapshot version). |
...
| `describe_extend_object_types` | in v22.3.2.1 | in v25.11.1.558 | Yes | Deduce concrete type of columns of type Object in DESCRIBE query |
...
| `dictionary_lazy_load` | in v26.7.1.1315 |  | Yes | Controls loading of a dictionary when specified in the `SETTINGS` clause of `CREATE DICTIONARY`: `1` defers loading until first use, `0` loads the dictionary at creation, `\'auto\'` follows the server setting `dictionaries_lazy_load`. Has no effect when set on a session or query level. |
...
| `discard_query_data` | in v26.7.1.1315 |  | Yes | If enabled, the server skips sending query result rows to the client. The query is still executed and logged fully on the server, and the client still receives the remaining packets.\n\nUsed for shadow traffic, benchmarks, and fuzzing.\n\nHas no effect for secondary queries.\n\nAffects only the native TCP protocol. |
...
| `distributed_cache_alignment` | in v25.7.1.3997 |  | Yes | Only has an effect in ClickHouse Cloud. A setting for testing purposes, do not change it |
...
| `distributed_cache_file_cache_name` | in v26.1.1.912 |  | Yes | Only has an effect in ClickHouse Cloud. A setting used only for CI tests - filesystem cache name to use on distributed cache. |
...
| `distributed_cache_registry_show_certificate_and_signature` | in v26.6.1.1193 |  | Yes | Only has an effect in ClickHouse Cloud. Show the `certificate` and `signature` columns in the `system.distributed_cache_registry` table. By default these columns are empty to keep the output compact; enable this setting to inspect them. |
...
| `distributed_cache_use_clients_cache_for_read` | in v25.12.1.649 |  | Yes | Only has an effect in ClickHouse Cloud. Use clients cache for read requests. |
| `distributed_cache_use_clients_cache_for_write` | in v25.12.1.649 | in v26.7.1.1315 | Yes | Only has an effect in ClickHouse Cloud. Use clients cache for write requests. |
...
| `distributed_cache_write_request_max_tries` | in v26.4.1.1141 |  | Yes | Only has an effect in ClickHouse Cloud. Number of tries to do distributed cache write request if unsuccessful |
...
| `distributed_plan_default_reader_bucket_count` | in v25.5.1.2782 |  | Yes | Default number of tasks for parallel reading in distributed query. Tasks are spread across between replicas. |
| `distributed_plan_default_shuffle_join_bucket_count` | in v25.5.1.2782 |  | Yes | Default number of buckets for distributed shuffle-hash-join. |
| `distributed_plan_execute_locally` | in v25.5.1.2782 |  | Yes | Run all tasks of a distributed query plan locally. Useful for testing and debugging. |
| `distributed_plan_fallback_to_local_execution` | in v26.9.1.1629 |  | Yes | When a query plan contains a step that does not support distributed execution, log the reason and execute the query on the initiator instead of throwing an exception. Disable to get an exception instead.\n\nOnly takes effect when `make_distributed_plan` (private preview) is enabled. |
| `distributed_plan_force_exchange_kind` | in v25.5.1.2782 |  | Yes | Force specified kind of Exchange operators between distributed query stages.\n\nPossible values:\n\n - \'\' - do not force any kind of Exchange operators, let the optimizer choose,\n - \'Persisted\' - use temporary files in object storage,\n - \'Streaming\' - stream exchange data over network. |
| `distributed_plan_force_shuffle_aggregation` | in v25.7.1.3997 |  | Yes | Use Shuffle aggregation strategy instead of PartialAggregation + Merge in distributed query plan. |
| `distributed_plan_max_rows_to_broadcast` | in v25.7.1.3997 |  | Yes | Maximum rows to use broadcast join instead of shuffle join in distributed query plan. |
| `distributed_plan_optimize_exchanges` | in v25.5.1.2782 |  | Yes | Removes unnecessary exchanges in distributed query plan. Disable it for debugging. |
| `distributed_plan_prefer_replicas_over_workers` | in v26.4.1.1141 |  | Yes | Serialize the distributed query plan for execution at replicas. |
| `distributed_plan_read_in_order` | in v26.9.1.1629 |  | Yes | Allow the read-in-order optimization for `ORDER BY` in a distributed query plan, so a sorted read of the\ntable\'s sorting key can skip the sort and stop early instead of scanning and sorting.\n\nOff by default: the rewrite that distributes a sort assumes the sort it wraps does not depend on its input\nalready being ordered, and a sort that does can be fed rows through an exchange that does not preserve\norder. Only shapes where no exchange survives between the read and the sort are safe today. |
| `distributed_plan_workers_num` | in v26.6.1.1193 |  | Yes | How many stateless workers will be used to execute this query. Zero disables stateless-worker leasing for distributed plans. |
| `distributed_plan_workers_provisioning_timeout_ms` | in v26.8.1.2041 |  | Yes | Total wall-clock time, in milliseconds, a query may spend provisioning stateless workers before execution: leasing them from the discovery service and verifying they are reachable. The query blocks up to this budget for the leased workers to become ready; when it elapses the query proceeds with the workers verified so far, or fails if none became available. Zero waits only for the initial lease-and-verify pass (no retries). |
...
| `dynamic_disk_allow_from_env` | in v26.3.17.110 |  | Yes | Allow using `from_env` substitutions in the dynamic disk configuration (i.e. in the `disk()` function arguments).\nDisabled by default to prevent users from reading arbitrary environment variables when defining table storage. |
| `dynamic_disk_allow_from_zk` | in v26.3.17.110 |  | Yes | Allow using `from_zk` substitutions in the dynamic disk configuration (i.e. in the `disk()` function arguments).\nDisabled by default. |
| `dynamic_disk_allow_include` | in v26.3.17.110 |  | Yes | Allow using `include` in the dynamic disk configuration (i.e. in the `disk()` function arguments).\nDisabled by default. |
| `dynamic_throw_on_type_mismatch` | in v26.3.14.49 |  | Yes | When applying a function to a [Dynamic](../../sql-reference/data-types/dynamic.md) column using the default implementation,\ncontrols what happens for rows whose actual type is incompatible with the function:\n- `true` (default) — throw an exception.\n- `false` — return `NULL` for those rows instead. |
...
| `enable_add_distinct_to_in_subqueries` | in v25.8.1.5101 |  | Yes | Enable `DISTINCT` in `IN` subqueries. This is a trade-off setting: enabling it can greatly reduce the size of temporary tables transferred for distributed IN subqueries and significantly speed up data transfer between shards, by ensuring only unique values are sent.\nHowever, enabling this setting adds extra merging effort on each node, as deduplication (DISTINCT) must be performed. Use this setting when network transfer is a bottleneck and the additional merging cost is acceptable. |
| `enable_alp_codec` | in v26.8.1.2041 |  | Yes | Allows using the experimental `ALP` compression codec. |
| `enable_analyzer` | in v24.8.1.2684 |  | Yes | Allow new query analyzer. |
| `enable_automatic_decision_for_merging_across_partitions_for_final` | in v26.2.1.1139 |  | Yes | If set, ClickHouse will automatically enable this optimization when the partition key expression is deterministic and all columns used in the partition key expression are included in the primary key.\nThis automatic derivation ensures that rows with the same primary key values will always belong to the same partition, making it safe to avoid cross-partition merges. |
...
| `enable_blob_storage_log_for_read_operations` | in v26.5.1.882 |  | Yes | Write information about blob storage read operations to system.blob_storage_log table.\nRequires `enable_blob_storage_log` to be enabled as well. |
| `enable_cascades_optimizer` | in v26.8.1.2041 |  | Yes | Enable the Cascades cost-based optimizer for distributed query plans.\nTakes effect only together with `make_distributed_plan = 1`: the setting alone does not change single-node query planning. |
...
| `enable_dynamic_type` | in v24.11.1.2557 | in v25.8.1.5101 | Yes | Allows creation of [Dynamic](../../sql-reference/data-types/dynamic.md) data type. |
...
| `enable_identifier_resolve_cache` | in v26.6.1.1193 |  | Yes | Enable the identifier resolution cache in the query analyzer. The cache shares resolved alias nodes to prevent AST explosion when the same alias is referenced multiple times. Set to false to disable caching if incorrect results are suspected.\n     |
| `enable_job_stack_trace` | in v23.7.1.2470 |  | Yes | Output stack trace of a job creator when job results in exception |
| `enable_join_fixed_hash_table_conversion` | in v26.4.1.1141 |  | Yes | Enable converting the hash table to a flat array for joins when the key is a single integer with a small value range. |
| `enable_join_key_only_hash_tables` | in v26.9.1.1629 |  | Yes | Use hash tables that store the join keys alone, without a reference to a right row, for joins whose result can never contain a value taken from a right row: `LEFT ANTI`, and `LEFT SEMI` when no right column is selected. Such a table has a smaller cell and lets the right blocks be dropped instead of stored. |
...
| `enable_materialized_cte` | in v26.3.1.896 |  | Yes | Enable materialized common table expressions, it will be preferred over enable_global_with_statement |
| `enable_materialized_postgresql_table` | in v26.9.1.1629 |  | Yes | Allows to use the `MaterializedPostgreSQL` table engine. |
...
| `enable_positional_arguments_for_projections` | in v25.10.4.104 |  | Yes | Enables or disables supporting positional arguments in PROJECTION definitions. See also [enable_positional_arguments](#enable_positional_arguments) setting.\n\n:::note\nThis is an expert-level setting, and you shouldn\'t change it if you\'re just getting started with ClickHouse.\n:::\n\nPossible values:\n\n- 0 — Positional arguments aren\'t supported.\n- 1 — Positional arguments are supported: column numbers can use instead of column names. |
...
| `enable_qbit_type` | in v26.1.1.912 | in v26.2.1.1139 | Yes | Allows creation of [QBit](../../sql-reference/data-types/qbit.md) data type. |
| `enable_quantized_codec` | in v26.8.1.2041 |  | Yes | Allows using the experimental `Quantized` compression codec. |
...
| `enable_unique_key` | in v26.9.1.1629 |  | Yes | Allows creation of tables with the `UNIQUE KEY` clause on MergeTree-family engines. |
| `enable_url_encoding` | in v23.7.2.25 |  | Yes |  Allows to enable/disable decoding/encoding path in uri in URL table engine |
| `enable_variant_type` | in v24.11.1.2557 | in v25.8.1.5101 | Yes | Allows creation of [Variant](../../sql-reference/data-types/variant.md) data type. |
| `enable_vector_similarity_index` | in v25.7.1.3997 | in v25.8.1.5101 | Yes | Enable vector similarity index. |
...
| `enable_zstd_qat_codec` | in v24.1.1.2048 | in v26.1.1.912 | Yes | Enable/disable the ZSTD_QAT codec. |
| `enable_zxc_codec` | in v26.8.1.2041 |  | Yes | Allows using the experimental `ZXC` compression codec. |
...
| `file_like_engine_default_partition_strategy` | in v26.6.1.1193 |  | Yes | Default partition strategy for file like engines. |
| `filesystem_cache_allow_background_download` | in v25.11.1.558 |  | Yes | Allow filesystem cache to enqueue background downloads for data read from remote storage. Disable to keep downloads in the foreground for the current query/session. |
...
| `force_creating_set_partitions_independently` | in v26.8.1.2041 |  | Yes | Force per-partition pre-deduplication for `IN (subquery)` set building when it is applicable, but the partition-skew check (largest partition more than twice the average) decided not to use it. Only bypasses the skew check of [allow_creating_set_partitions_independently](#allow_creating_set_partitions_independently); the remaining conditions still apply. |
...
| `force_distinct_partitions_independently` | in v26.8.1.2041 |  | Yes | Force independent `DISTINCT` evaluation per partition when it is applicable, but the cost heuristic decided not to use it. Only bypasses the cost heuristic of [allow_distinct_partitions_independently](#allow_distinct_partitions_independently); the remaining conditions still apply. |
...
| `force_read_through_distributed_cache` | in v26.8.1.2041 |  | Yes | Only has an effect in ClickHouse Cloud. Overrides the server setting `enable_read_through_distributed_cache` for a single query. `auto` (the default) means to follow the server setting. |
...
| `force_window_partitions_independently` | in v26.8.1.2041 |  | Yes | Force independent evaluation of window functions per partition when it is applicable, but the cost heuristic decided not to use it. Only bypasses the cost heuristic of [allow_window_partitions_independently](#allow_window_partitions_independently); the remaining conditions still apply. |
| `force_write_through_distributed_cache` | in v26.8.1.2041 |  | Yes | Only has an effect in ClickHouse Cloud. Overrides the server setting `enable_write_through_distributed_cache` for a single query. `auto` (the default) means to follow the server setting. |
| `format` | in v26.8.1.2041 |  | Yes | Overrides the `FORMAT` of the query for both input and output. Wins over the format specified in the query and in the file extension. The more specific `input_format` and `output_format` settings take precedence over this generic `format` setting for their respective direction. |
| `format_avro_schema_registry_connection_timeout` | in v26.5.1.882 |  | Yes | For AvroConfluent format: connection timeout in seconds for the Confluent Schema Registry HTTP client. Used by both schema fetch and schema registration. Must be greater than 0 and less than 600 (10 minutes). |
| `format_avro_schema_registry_max_retries` | in v26.6.1.1193 |  | Yes | For AvroConfluent format: maximum number of retries for transient failures when communicating with the Confluent Schema Registry (transport timeouts, connection refused, DNS errors, HTTP 5xx/408/429). Set to 0 to disable retries. The maximum allowed value is 20. Schema validation errors (HTTP 409, malformed Avro JSON) are not retried. |
| `format_avro_schema_registry_receive_timeout` | in v26.5.1.882 |  | Yes | For AvroConfluent format: receive timeout in seconds for the Confluent Schema Registry HTTP client. Used by both schema fetch and schema registration. Must be greater than 0 and less than 600 (10 minutes). |
| `format_avro_schema_registry_retry_initial_backoff_ms` | in v26.6.1.1193 |  | Yes | For AvroConfluent format: initial backoff in milliseconds before retrying a failed Confluent Schema Registry request. The backoff doubles on each subsequent retry, capped at 10 seconds. Must be greater than 0 and less than or equal to 60000. |
| `format_avro_schema_registry_send_timeout` | in v26.5.1.882 |  | Yes | For AvroConfluent format: send timeout in seconds for the Confluent Schema Registry HTTP client. Used by both schema fetch and schema registration. Must be greater than 0 and less than 600 (10 minutes). |
...
| `format_binary_max_object_size` | in v25.12.1.649 |  | Yes | The maximum allowed number of paths in a single Object for JSON type RowBinary format. It prevents allocating large amount of memory in case of corrupted data. 0 means there is no limit |
...
| `format_capn_proto_max_message_size` | in v25.12.1.649 |  | Yes | Maximum size of a single CapnProto message in bytes. This protects against malformed or corrupted data causing excessive memory allocation. Default is 1 GiB. |
...
| `formatdatetime_e_with_space_padding` | in v25.5.1.2782 |  | Yes | Formatter \'%e\' in function \'formatDateTime\' prints single-digit days with a leading space, e.g. \' 2\' instead of \'2\'.\n     |
...
| `functions_h3_default_if_invalid` | in v26.2.5.45 |  | Yes | If false, h3 functions, e.g. h3CellAreaM2, throw an exception if input is invalid. If true, they return 0 or default value. |
...
| `geotoh3_argument_order` | in v25.5.1.2782 |  | Yes | Function \'geoToH3\' accepts (lon, lat) if set to \'lon_lat\' and (lat, lon) if set to \'lat_lon\'. |
...
| `highlight_max_matches_per_row` | in v26.4.1.1141 |  | Yes | Sets the maximum number of highlight matches per row in the [highlight](/sql-reference/functions/string-search-functions#highlight) function. Use it to protect against excessive memory usage when highlighting highly repetitive patterns in large texts.\n\nPossible values:\n\n- Positive integer. |
...
| `http_headers_read_timeout` | in v26.1.12.23 |  | Yes | Maximum time in seconds to read all HTTP request headers. This is a total deadline for the entire header parsing phase, not a per-read timeout. Protects against slowloris-style attacks where a client trickles header data slowly to hold connections open. |
...
| `http_max_request_header_size` | in v26.1.12.23 |  | Yes | Maximum total size of all HTTP request headers (names and values combined) in bytes. |
...
| `iceberg_expire_default_max_ref_age_ms` | in v26.3.1.896 |  | Yes | Default value for Iceberg table property `history.expire.max-ref-age-ms` used by `expire_snapshots` when that property is absent. |
| `iceberg_expire_default_max_snapshot_age_ms` | in v26.3.1.896 |  | Yes | Default value for Iceberg table property `history.expire.max-snapshot-age-ms` used by `expire_snapshots` when that property is absent. |
| `iceberg_expire_default_min_snapshots_to_keep` | in v26.3.1.896 |  | Yes | Default value for Iceberg table property `history.expire.min-snapshots-to-keep` used by `expire_snapshots` when that property is absent. |
| `iceberg_file_entries_queue_size` | in v26.8.9.10 |  | Yes | Capacity of the queue between the Iceberg data manifest decode tasks and the query, in data file entries.\n\nThe decode tasks pause once the queue is full and the query is not consuming, so this also bounds the read-ahead.\n\nMust be greater than zero. |
| `iceberg_insert_max_bytes_in_data_file` | in v25.9.2.1 |  | Yes | Max rows of iceberg parquet data file on insert operation. |
| `iceberg_insert_max_partitions` | in v25.12.1.649 |  | Yes | Max allowed partitions count per one insert operation for Iceberg table engine. |
| `iceberg_insert_max_rows_in_data_file` | in v25.9.2.1 |  | Yes | Max rows of iceberg parquet data file on insert operation. |
| `iceberg_manifest_decode_concurrency` | in v26.8.9.10 |  | Yes | Maximum number of Iceberg manifest files decoded concurrently while reading a table.\n\nDelete manifests are all decoded before any data file is read; data manifests are decoded while the list of data files for the query is produced, and new ones are decoded only as the query consumes already decoded entries. Decoding several manifests at a time overlaps the object storage round-trips and the per-entry pruning work.\n\nHigher values raise peak memory when the Iceberg metadata files cache is disabled or full, since each in-flight manifest then holds its own decoded contents.\n\nMust be greater than zero; `1` decodes the manifests one at a time. |
| `iceberg_manifest_min_count_to_compact` | in v26.7.1.1315 |  | Yes | Minimum number of manifest files required to trigger manifest-only compaction via OPTIMIZE TABLE ... MANIFEST.\nIf the current number of manifest files is less than or equal to this threshold, compaction is skipped.\nRequires allow_experimental_iceberg_compaction to be enabled. |
| `iceberg_max_number_datafiles_to_compact` | in v26.5.1.882 |  | Yes | Threshold for compaction data files in iceberg. |
...
| `iceberg_metadata_staleness_ms` | in v26.3.1.896 |  | Yes | If non-zero, skip fetching iceberg metadata from remote catalog if there is a cached metadata snapshot, more recent than the given staleness window. Zero means to always fetch the latest metadata version from the remote catalog. Setting this a non-zero trades staleness to a lower latency of read operations. |
| `iceberg_orphan_files_older_than_seconds` | in v26.4.1.1141 |  | Yes | Default age threshold in seconds for orphan file removal in Iceberg tables. Files newer than this are not considered orphans. Used when the older_than argument is omitted from the remove_orphan_files() procedure call. Default is 259200 (3 days). |
| `iceberg_snapshot_id` | in v25.4.1.2934 |  | Yes | Query Iceberg table using the specific snapshot id. |
| `iceberg_timestamp_ms` | in v25.4.1.2934 |  | Yes | Query Iceberg table using the snapshot that was current at a specific timestamp. |
...
| `ignore_format_null_for_explain` | in v26.2.1.1139 |  | Yes | If enabled, `FORMAT Null` will be ignored for `EXPLAIN` queries and default output format will be used instead.\nWhen disabled, `EXPLAIN` queries with `FORMAT Null` will produce no output (backward compatible behavior). |
...
| `ignore_on_cluster_for_replicated_database` | in v26.1.1.912 |  | Yes | Always ignore ON CLUSTER clause for DDL queries with replicated databases. |
| `ignore_on_cluster_for_replicated_handler_queries` | in v26.8.1.2041 |  | Yes | Ignore ON CLUSTER clause for replicated handler management queries. |
...
| `input_format` | in v26.8.1.2041 |  | Yes | Overrides the input format of the query. Wins over the format specified in the query. |
...
| `input_format_arrow_use_native_reader` | in v26.7.1.1315 | in v26.8.1.2041 | Yes | Use the native ClickHouse reader for the Arrow and ArrowStream formats instead of the one based on the Apache Arrow library. |
...
| `input_format_binary_max_type_complexity` | in v26.1.1.912 |  | Yes | Max type nodes when decoding binary types (not depth, but total count). `Map(String, UInt32)` = 3 nodes. Protects against malicious inputs. 0 = unlimited. |
...
| `input_format_column_name_matching_mode` | in v26.4.1.1141 |  | Yes | Defines the column name matching mode when ingesting data through various formats (including but not limited to JSONEachRow, CSVWithNames, JSONColumns, BSONEachRow, RowBinaryWithNames).\nSupported modes:\n    - match_case: match case-sensitively\n    - ignore_case: match case-insensitively\n    - auto: first tries to match case-sensitively, if fails, tries to match case-insensitively. |
| `input_format_connection_handling` | in v26.2.1.1139 |  | Yes |     When this option is enabled, if the connection closes unexpectedly, any remaining data in the buffer will be parsed and processed instead of being treated as an error\n\n:::note\nEnabling this option disables parallel parsing and makes deduplication impossible\n::: |
...
| `input_format_geojson_unsupported_geometry_handling` | in v26.6.1.1193 |  | Yes | Controls what happens when a valid `GeoJSON` geometry type that cannot be represented in ClickHouse\'s `Geometry` type (such as `GeometryCollection` or `MultiPoint`) must be stored in the `geometry` column while reading `GeoJSON` input.\n\nPossible values:\n- `\'throw\'` (default) — throw an exception.\n- `\'null\'` — insert a `NULL` value for the `geometry` column and continue parsing.\n\nThis applies only when the `geometry` column is materialized. When it is not a requested output column, such a geometry is validated for well-formedness but does not trigger the handling. |
...
| `input_format_json_infer_array_of_dynamic_from_array_of_different_types` | in v25.8.1.5101 |  | Yes | If enabled, during schema inference ClickHouse will use Array(Dynamic) type for JSON arrays with values of different data types.\n\nExample:\n\n```sql\nSET input_format_json_infer_array_of_dynamic_from_array_of_different_types=1;\nDESC format(JSONEachRow, \'{"a" : [42, "hello", [1, 2, 3]]}\');\n```\n\n```response\n┌─name─┬─type───────────┐\n│ a    │ Array(Dynamic) │\n└──────┴────────────────┘\n```\n\n```sql\nSET input_format_json_infer_array_of_dynamic_from_array_of_different_types=0;\nDESC format(JSONEachRow, \'{"a" : [42, "hello", [1, 2, 3]]}\');\n```\n\n```response\n┌─name─┬─type─────────────────────────────────────────────────────────────┐\n│ a    │ Tuple(Nullable(Int64), Nullable(String), Array(Nullable(Int64))) │\n└──────┴──────────────────────────────────────────────────────────────────┘\n```\n\nEnabled by default. |
...
| `input_format_json_map_as_array_of_tuples` | in v25.7.1.3997 |  | Yes | Deserialize maps columns as JSON arrays of tuples.\n\nDisabled by default. |
...
| `input_format_json_max_object_size` | in v26.8.1.2041 |  | Yes | Maximum allowed size of a single JSON object in bytes. Objects exceeding this limit are rejected as likely malformed. This protects against memory exhaustion when a malformed JSON document is parsed as a single object. The same limit is applied in both parallel and non-parallel parsing paths. Set to 0 to disable the check. |
| `input_format_json_max_string_column_growth_step` | in v26.8.1.2041 |  | Yes | When building the JSON column\'s internal String buffers while parsing JSON from string, cap the power-of-two growth at this many bytes: once the reserved size reaches this value, the buffer grows by increments of this size instead of doubling. This bounds over-allocation for large JSON columns. 0 means unlimited (pure doubling). |
...
| `input_format_max_block_size_bytes` | in v25.5.1.2782 |  | Yes | Limits the size of the blocks formed during data parsing in input formats in bytes. Used in row based input formats when block is formed on ClickHouse side.\n0 means no limit in bytes. |
| `input_format_max_block_wait_ms` | in v26.2.1.1139 |  | Yes | Limits the maximum time in milliseconds to wait before emitting a block during parsing in row-based input formats. 0 means no limit.\n\n:::note\nThis option only works if `input_format_connection_handling` is enabled. Setting a value also disables parallel parsing and makes deduplication impossible.\n::: |
...
| `input_format_orc_use_fast_decoder` | in v23.8.1.2992 | in v26.8.1.2041 | Yes | Use a faster ORC decoder implementation. |
| `input_format_parallel_parsing` | in v20.1.2.4 |  | Yes | Enable parallel parsing for some data formats. |
| `input_format_parquet_allow_geoparquet_parser` | in v25.5.1.2782 |  | Yes | Use geo column parser to convert Array(UInt8) into Point/Linestring/Polygon/MultiLineString/MultiPolygon types |
...
| `input_format_parquet_spatial_filter_push_down` | in v26.8.1.2041 |  | Yes | When reading GeoParquet files, skip whole row groups and, together with `input_format_parquet_page_filter_push_down`, individual pages based on spatial predicates in the WHERE clause and the geometry bounding box statistics (`geospatial_statistics.bbox` or `covering.bbox` columns) in the Parquet metadata. |
| `input_format_parquet_use_native_reader` | in v24.6.1.4423 | in v25.12.1.649 | Yes | When reading Parquet files, to use native reader instead of arrow reader. |
| `input_format_parquet_use_native_reader_v3` | in v25.8.1.5101 | in v26.5.1.882 | Yes | Use Parquet reader v3. Experimental. |
...
| `input_format_parquet_verify_checksums` | in v25.11.1.558 |  | Yes | Verify page checksums when reading parquet files. |
...
| `into_outfile_create_parent_directories` | in v25.11.1.558 |  | Yes | Automatically create parent directories when using INTO OUTFILE if they do not already exists. |
...
| `jemalloc_profile_text_collapsed_use_count` | in v26.2.1.1139 |  | Yes | When using the \'collapsed\' output format for jemalloc heap profile, aggregate by allocation count instead of bytes. When false (default), each stack is weighted by live bytes; when true, by live allocation count.\n     |
| `jemalloc_profile_text_output_format` | in v26.2.1.1139 |  | Yes | Output format for jemalloc heap profile in system.jemalloc_profile_text table. Can be: \'raw\' (raw profile), \'symbolized\' (jeprof format with symbols), or \'collapsed\' (FlameGraph format).\n     |
| `jemalloc_profile_text_symbolize_with_inline` | in v26.2.1.1139 |  | Yes | Whether to include inline frames when symbolizing jemalloc heap profile. When enabled, inline frames are included which can slow down symbolization process drastically; when disabled, they are skipped. Only affects \'symbolized\' and \'collapsed\' output formats.\n     |
...
| `join_runtime_bloom_filter_max_ratio_of_set_bits` | in v26.1.1.912 |  | Yes | If the number of set bits in a runtime bloom filter exceeds this ratio the filter is completely disabled to reduce the overhead. |
| `join_runtime_filter_blocks_to_skip_before_reenabling` | in v26.1.1.912 |  | Yes | Number of blocks that are skipped before trying to dynamically re-enable a runtime filter that previously was disabled due to poor filtering ratio. |
...
| `join_runtime_filter_from_fixed_hash_table` | in v26.6.1.1193 |  | Yes | When the hash join build side was converted to a FixedHashMap (see `enable_join_fixed_hash_table_conversion`), use that hash map directly as the runtime filter. |
| `join_runtime_filter_min_probe_rows` | in v26.8.1.2041 |  | Yes | If, at query planning time, the probe side of a JOIN is estimated to produce no more than this number of rows, the JOIN runtime filter is not created. Building and applying a runtime filter for a tiny probe side costs more than it saves. Set to 0 to always create the runtime filter regardless of the estimated probe size. |
| `join_runtime_filter_pass_ratio_threshold_for_disabling` | in v26.1.1.912 |  | Yes | If ratio of passed rows to checked rows is greater than this threshold the runtime filter is considered as poorly performing and is disabled for the next `join_runtime_filter_blocks_to_skip_before_reenabling` blocks to reduce the overhead. |
| `join_runtime_filter_size_from_hash_table_stats` | in v26.7.1.1315 |  | Yes | Use hash table size statistics collected from previous executions to size the JOIN runtime filter. When disabled, fall back to the fixed `join_runtime_bloom_filter_bytes`. |
...
| `live_view_heartbeat_interval` | in v19.14.3.3 | in v25.11.1.558 | Yes | The heartbeat interval in seconds to indicate live query is alive. |
...
| `low_priority_query_wait_time_ms` | in v25.4.1.2934 |  | Yes | When the query prioritization mechanism is employed (see setting `priority`), low-priority queries wait for higher-priority queries to finish. This setting specifies the duration of waiting. |
| `make_distributed_plan` | in v25.5.1.2782 |  | Yes | Make distributed query plan. |
...
| `materialize_statistics_on_insert_max_table_size` | in v26.8.1.2041 |  | Yes | Only build and store column statistics for newly inserted parts (see `materialize_statistics_on_insert`) for tables whose current size plus the block being written, does not exceed this value. `0` means no size limit. |
...
| `max_consume_snapshots` | in v26.5.1.882 |  | Yes | Maximum number of Paimon snapshots to consume per incremental read. 0 means no limit. |
...
| `max_dynamic_subcolumns_in_json_type_parsing` | in v26.1.1.912 |  | Yes | The maximum number of dynamic subcolumns that can be created in every column during parsing of JSON column.\nIt allows to control the number of dynamic subcolumns during parsing regardless of dynamic parameters specified in the data type. |
...
| `max_insert_threads_min_free_memory_per_thread` | in v26.5.1.882 |  | Yes | Same as `max_threads_min_free_memory_per_thread`, but applied to `max_insert_threads` instead of `max_threads`. The default is higher because insert pipelines typically hold larger per-thread buffers (merge tree parts, compression blocks) than read pipelines.\n\nIf the amount of free memory is less than `max_insert_threads` multiplied by this value, `max_insert_threads` is reduced to fit, down to a minimum of `1`.\n\nSet to `0` to disable this limit. |
| `max_joined_block_size_bytes` | in v25.8.1.5101 |  | Yes | Maximum block size in bytes for JOIN result (if join algorithm supports it). 0 means unlimited. |
...
| `max_limit_for_ann_queries` | in v22.9.1.2603 | in v25.5.1.2782 | Yes | Maximum limit value for using ANN indexes is used to prevent memory overflow in search queries for indexes |
| `max_limit_for_vector_search_queries` | in v25.5.1.2782 |  | Yes | SELECT queries with LIMIT bigger than this setting cannot use vector similarity indices. Helps to prevent memory overflows in vector similarity indices. |
| `max_live_view_insert_blocks_before_refresh` | in v19.14.3.3 | in v25.11.1.558 | Yes | Limit maximum number of inserted blocks after which mergeable blocks are dropped and query is re-executed. |
...
| `max_number_of_partitions_for_independent_distinct` | in v26.8.1.2041 |  | Yes | Maximal number of partitions in table to apply independent `DISTINCT` per partition. Part of the cost heuristic of [allow_distinct_partitions_independently](#allow_distinct_partitions_independently). |
| `max_number_of_partitions_for_independent_window` | in v26.8.1.2041 |  | Yes | Maximal number of partitions in table to apply independent evaluation of window functions per partition. Part of the cost heuristic of [allow_window_partitions_independently](#allow_window_partitions_independently). |
| `max_os_cpu_wait_time_ratio_to_throw` | in v25.4.1.2934 |  | Yes | Max ratio between OS CPU wait (OSCPUWaitMicroseconds metric) and busy (OSCPUVirtualTimeMicroseconds metric) times to consider rejecting queries. Linear interpolation between min and max ratio is used to calculate the probability, the probability is 1 at this point. |
...
| `max_projection_rows_to_use_projection_index` | in v25.11.1.558 |  | Yes | If the number of rows to read from the projection index is less than or equal to this threshold, ClickHouse will try to apply the projection index during query execution. |
...
| `max_rand_distribution_parameter` | in v26.4.1.1141 |  | Yes | Maximum value for distribution shape parameters in random distribution functions such as `randChiSquared`, `randStudentT`, and `randFisherF`. This prevents extremely long computation times with extreme parameter values. |
| `max_rand_distribution_trials` | in v26.4.1.1141 |  | Yes | Maximum number of trials allowed for random distribution functions such as `randBinomial` and `randNegativeBinomial`. This prevents extremely long computation times with large trial counts. |
...
| `max_reverse_dictionary_lookup_cache_size_bytes` | in v25.12.1.649 |  | Yes | Maximum size in bytes of the per-query reverse dictionary lookup cache used by the function `dictGetKeys`. The cache stores serialized key tuples per attribute value to avoid re-scanning the dictionary within the same query. When the limit is reached, entries are evicted using LRU. Set to 0 to disable caching. |
| `max_rows_for_lazy_final` | in v26.4.1.1141 |  | Yes | Maximum number of rows in the set for lazy FINAL optimization. If exceeded, falls back to normal FINAL. |
...
| `max_skip_unavailable_shards_num` | in v26.3.1.896 |  | Yes | When `skip_unavailable_shards` is enabled, limits the maximum number of shards that can be silently skipped.\nIf the number of unavailable shards exceeds this value, an exception is thrown instead of silently skipping.\n\nA value of 0 means no limit (default behavior — all unavailable shards can be skipped). |
| `max_skip_unavailable_shards_ratio` | in v26.3.1.896 |  | Yes | When `skip_unavailable_shards` is enabled, limits the maximum ratio (0 to 1) of shards that can be silently skipped.\nIf the ratio of unavailable shards to total shards exceeds this value, an exception is thrown instead of silently skipping.\n\nA value of 0 means no limit (default behavior — all unavailable shards can be skipped). |
| `max_streams_for_files_processing_in_cluster_functions` | in v25.12.1.649 |  | Yes | If is not zero, limit the number of threads reading data from files in *Cluster table functions. |
...
| `max_wkb_geometry_elements` | in v26.4.1.1141 |  | Yes | Maximum number of points, rings, or polygons allowed in a single WKB geometry element during parsing by `readWKB` and related functions. This protects against excessive memory allocations from malformed WKB data. Set to 0 to use the hard-coded limit (100 million). |
...
| `merge_tree_prefetch_json_shared_data_substreams` | in v26.8.1.2041 |  | Yes | Enables prefetching of JSON shared data substreams in Wide parts that are read by seeking to a mark. Such a prefetch reads from the beginning of the granule, which is usually not the position the substream is read from, so it can be wasted. Disable to skip these prefetches. |
...
| `merge_tree_storage_snapshot_sleep_ms` | in v25.6.1.3206 |  | Yes | Inject artificial delay (in milliseconds) when creating a storage snapshot for MergeTree tables.\nUsed for testing and debugging purposes only.\n\nPossible values:\n- 0 - No delay (default)\n- N - Delay in milliseconds |
...
| `min_count_to_compile_regular_expression` | in v26.7.1.1315 |  | Yes | Minimum count of executing same regular expression before it is get compiled. |
...
| `min_external_sort_block_bytes` | in v25.1.1.4165 | in v25.3.4.190 | Yes | Minimal block size in bytes for external sort that will be dumped to disk, to avoid too many files. |
...
| `min_filtered_ratio_for_lazy_final` | in v26.4.1.1141 |  | Yes | Minimum ratio of marks filtered by index analysis for lazy FINAL optimization. If less than this fraction of marks is filtered, falls back to normal FINAL. Value 0 disables this check. |
...
| `opentelemetry_start_keeper_trace_probability` | in v26.2.1.1139 |  | Yes | Probability to start a trace for ZooKeeper request - whether there is a parent trace or not.\n\nPossible values:\n- \'auto\' - Equals the opentelemetry_start_trace_probability setting\n- 0 — Tracing is disabled\n- 0 to 1 — Probability (e.g., 1.0 = always enable)\n |
...
| `opentelemetry_trace_cpu_scheduling` | in v25.8.1.5101 |  | Yes | Collect OpenTelemetry spans for workload preemptive CPU scheduling. |
...
| `optimize_const_name_size` | in v25.11.1.558 |  | Yes | Replace with scalar and use hash as a name for large constants (size is estimated by the name length).\n\nPossible values:\n\n- positive integer - max length of the name,\n- 0 — always,\n- negative integer - never. |
| `optimize_count_from_files` | in v23.8.1.2992 |  | Yes | Optimize counting rows from files in supported input formats |
| `optimize_dictget_tuple_element` | in v26.5.1.882 |  | Yes | Rewrite `tupleElement(dictGet(\'dict\', (\'a\', \'b\', \'c\'), key), 2)` into `dictGet(\'dict\', \'b\', key)` to avoid fetching unnecessary dictionary attributes. Supports positional (`.1`, `.2`, ...) and named (`.b`) access, and also applies to `dictGetOrDefault` when the default argument is a constant tuple or a `tuple(...)` of constants. |
...
| `optimize_dry_run_check_part` | in v26.2.1.1139 |  | Yes | When enabled, `OPTIMIZE ... DRY RUN` validates the resulting merged part using `checkDataPart`. If the check fails, an exception is thrown. |
...
| `optimize_injective_functions_in_limit_by` | in v26.6.1.1193 |  | Yes | Replaces injective functions by their arguments in LIMIT BY section.\n\nExample: `LIMIT 5 BY toString(x)` becomes `LIMIT 5 BY x`. |
...
| `optimize_redundant_comparisons` | in v26.7.1.1315 |  | Yes | Detect conflicting and redundant comparison conditions on the same expression within AND chains. For example, `a < 1 AND a > 5` would be rewritten to `false`. |
...
| `optimize_rewrite_has_to_in` | in v26.6.1.1193 |  | Yes | Rewrite `has` functions to `IN` when the first argument is a constant array. For example, `has([1, 2, 3], x)` can be rewritten to `x IN [1, 2, 3]` for better performance with constant arrays |
...
| `optimize_use_projection_filtering` | in v25.6.1.3206 |  | Yes | Enables using projections to filter part ranges even when projections are not selected to perform SELECT query. |
...
| `order` | in v26.8.1.2041 |  | Yes | Adds an `ORDER BY` clause to the query as a wrapping subquery. Accepts an arbitrary expression list.\n\nThis is a query-construction setting applied by the engine on the parsed query (wrapping it as a derived table), so it composes with the existing query and works on every protocol: it can be supplied via the HTTP URL parameter, an in-query `SETTINGS` clause, or a user profile.\n\nIt shapes result-producing `SELECT` / `UNION` queries. For a write query (`INSERT … SELECT`, `CREATE … AS SELECT`) it takes effect only when the source `SELECT` carries it in its own `SETTINGS` clause; a value inherited from a profile or session, or set on the `INSERT` / `CREATE` statement itself, does not propagate into the source `SELECT` — the same non-propagation rule that applies to any other setting. |
...
| `output_format` | in v26.8.1.2041 |  | Yes | Overrides the output format of the query. Wins over the format specified in the query, in the file extension, or via `default_format`. |
| `output_format_always_quote_identifiers` | in v24.9.1.3278 |  | up to v24.9.1.3278 | Always quote identifiers |
| `output_format_always_write_decimal_point_in_float_and_decimal` | in v26.6.1.1193 |  | Yes | Always print a decimal point for floating-point and Decimal numbers in text formats, even when the value is a whole number. For example, output `1.` instead of `1`.\n\nDisabled by default. |
...
| `output_format_arrow_date_as_uint16` | in v26.2.1.1139 |  | Yes | Write Date values as plain 16-bit numbers (read back as UInt16), instead of converting to a 32-bit Arrow DATE32 type (read back as Date32). |
...
| `output_format_arrow_use_native_writer` | in v26.7.1.1315 | in v26.8.1.2041 | Yes | Use the native ClickHouse writer for the Arrow and ArrowStream formats instead of the one based on the Apache Arrow library. |
...
| `output_format_avro_confluent_subject` | in v26.5.1.882 |  | Yes | For AvroConfluent output format: the subject name under which the schema is registered in the Confluent Schema Registry. Required when writing AvroConfluent output. |
...
| `output_format_json_map_as_array_of_tuples` | in v25.7.1.3997 |  | Yes | Serialize maps columns as JSON arrays of tuples.\n\nDisabled by default. |
...
| `output_format_native_use_flattened_dynamic_and_json_serialization` | in v25.6.1.3206 |  | Yes | Write data of [JSON](../../sql-reference/data-types/newjson.md) and [Dynamic](../../sql-reference/data-types/dynamic.md) columns in a flattened format (all types/paths as separate subcolumns). |
...
| `output_format_orc_compression_block_size` | in v25.8.1.5101 |  | Yes | The size of the compression block in bytes for ORC output format. |
...
| `output_format_parquet_compliant_nested_types` | in v23.5.1.3174 | in v26.5.1.882 | Yes | In parquet file schema, use name \'element\' instead of \'item\' for list elements. This is a historical artifact of Arrow library implementation. Generally increases compatibility, except perhaps with some old versions of Arrow. |
...
| `output_format_parquet_geometadata` | in v25.7.1.3997 |  | Yes | Allow to write information about geo columns in parquet metadata and encode columns in WKB format. |
| `output_format_parquet_max_dictionary_size` | in v25.8.1.5101 |  | Yes | If dictionary size grows bigger than this many bytes, switch to encoding without dictionary. Set to 0 to disable dictionary encoding. |
...
| `output_format_parquet_unsupported_types_as_binary` | in v26.4.1.1141 | in v26.5.1.882 | Yes | Output types having no conversion as raw binary data. If false - such types would raise UNKNOWN_TYPE exception. |
| `output_format_parquet_use_custom_encoder` | in v23.7.1.2470 | in v26.5.1.882 | Yes | Use experimental faster Parquet encoder implementation. |
| `output_format_parquet_version` | in v23.3.1.2823 | in v26.5.1.882 | Yes | Parquet format version for output format. Supported versions: 1.0, 2.4, 2.6 and 2.latest (default) |
| `output_format_parquet_wide_integer_as_decimal` | in v26.8.1.2041 |  | Yes | Write `Int128`, `UInt128`, `Int256`, and `UInt256` values as standards-compliant Parquet `DECIMAL` values in big-endian byte order. The default keeps the legacy unannotated little-endian `FIXED_LEN_BYTE_ARRAY` representation for compatibility with older ClickHouse versions. The decimal representation enables interoperable numeric statistics, but some Parquet readers do not support precisions above 38 or 76. |
...
| `output_format_parquet_write_checksums` | in v25.11.1.558 |  | Yes | Put crc32 checksums in parquet page headers. |
...
| `output_format_pretty_named_tuples_as_json` | in v25.12.1.649 |  | Yes |         Controls whether named tuples in Pretty format are output as pretty-printed JSON objects. |
...
| `output_format_trim_fixed_string` | in v26.3.1.896 |  | Yes | Trim trailing null bytes from FixedString values in text output formats. E.g. `toFixedString(\'John\', 8)` is printed as `John` instead of `John\\0\\0\\0\\0`. |
...
| `page` | in v26.8.1.2041 |  | Yes | Sets the page number for paginated results. Equivalent to `offset = limit * (page - 1)`. Can only be specified when `limit` is set and `offset` is not. Pages are 1-based. Inherits the same negative/fractional support as `limit` and `offset`.\n\nThis is a query-construction setting applied by the engine on the parsed query (wrapping it as a derived table), so it composes with the existing query and works on every protocol: it can be supplied via the HTTP URL parameter, an in-query `SETTINGS` clause, or a user profile.\n\nIt shapes result-producing `SELECT` / `UNION` queries. For a write query (`INSERT … SELECT`, `CREATE … AS SELECT`) it takes effect only when the source `SELECT` carries it in its own `SETTINGS` clause; a value inherited from a profile or session, or set on the `INSERT` / `CREATE` statement itself, does not propagate into the source `SELECT` — the same non-propagation rule that applies to any other setting. |
| `page_cache_block_size` | in v25.5.1.2782 |  | Yes | Size of file chunks to store in the userspace page cache, in bytes. All reads that go through the cache will be rounded up to a multiple of this size.\n\nThis setting can be adjusted on a per-query level basis, but cache entries with different block sizes cannot be reused. Changing this setting effectively invalidates existing entries in the cache.\n\nA higher value, like 1 MiB is good for high-throughput queries, and a lower value, like 64 KiB is good for low-latency point queries. |
...
| `parallel_hash_join_threshold` | in v25.3.4.190 |  | Yes | When hash-based join algorithm is applied, this threshold helps to decide between using `hash` and `parallel_hash` (only if estimation of the right table size is available).\nThe former is used when we know that the right table size is below the threshold. |
| `parallel_non_joined_rows_processing` | in v26.2.1.1139 |  | Yes | Allow multiple threads to process non-joined rows from the right table in parallel during RIGHT and FULL JOINs.\nThis can speed up the non-joined phase when using the `parallel_hash` join algorithm with large tables.\nWhen disabled, non-joined rows are processed by a single thread. |
...
| `parallel_replicas_allow_materialized_views` | in v25.12.1.649 |  | Yes | Allow usage of materialized views with parallel replicas |
| `parallel_replicas_allow_merge_tables` | in v26.9.1.1629 |  | Yes | Allow reading from a `Merge` table with parallel replicas. Effective only together with [parallel_replicas_plan_based](#parallel_replicas_plan_based): the read from the `Merge` table is expanded into a union of the reads from the underlying `MergeTree` tables, which is then distributed like any other union. A `Merge` table is left to a single replica when any of its underlying tables cannot be read that way (a non-`MergeTree` table, a `FINAL` read). Set it to `false` to read every `Merge` table on a single replica, as before the support was added. Experimental. |
| `parallel_replicas_allow_view_over_mergetree` | in v26.4.1.1141 |  | Yes | Allow parallel replicas to execute the outer query of a simple view over `MergeTree` tables (instead of the view\'s inner query), improving parallelization across nodes. Also applies to `UNION ALL` views whose branches all read from different `MergeTree` tables. |
| `parallel_replicas_connect_timeout_ms` | in v25.6.1.3206 |  | Yes | The timeout in milliseconds for connecting to a remote replica during query execution with parallel replicas. If the timeout is expired, the corresponding replicas is not used for query execution |
...
| `parallel_replicas_filter_pushdown` | in v25.12.5.44 |  | Yes | Allow pushing down filters to part of query which parallel replicas choose to execute |
...
| `parallel_replicas_insert_select_local_pipeline` | in v25.4.1.2934 |  | Yes | Use local pipeline during distributed INSERT SELECT with parallel replicas |
...
| `parallel_replicas_support_projection` | in v25.8.1.5101 |  | Yes | Optimization of projections can be applied in parallel replicas. Effective only with enabled parallel_replicas_local_plan and aggregation_in_order is inactive. |
...
| `parsedatetime_e_requires_space_padding` | in v25.5.1.2782 |  | Yes | Formatter \'%e\' in function \'parseDateTime\' expects that single-digit days are space-padded, e.g., \' 2\' is accepted but \'2\' raises an error.\n     |
...
| `per_part_index_stats` | in v25.8.1.5101 |  | Yes |         Logs index statistics per part |
| `periodic_live_view_refresh` | in v21.2.2.8 | in v25.11.1.558 | Yes | Interval after which periodically refreshed live view is forced to refresh. |
| `poll_interval` | in v1.1.54019 |  | Yes | Block at the query wait cycle on the server for the specified number of seconds. |
| `polyglot_dialect` | in v26.3.1.896 |  | Yes | Source SQL dialect for the polyglot transpiler (e.g. \'sqlite\', \'mysql\', \'postgresql\', \'snowflake\', \'duckdb\'). |
...
| `predicate_statistics_sample_rate` | in v26.5.1.882 |  | Yes | Collect predicate selectivity statistics into `system.predicate_statistics_log`. When set to N > 0, approximately 1/N of queries are sampled (by the query ID). 0 means disabled. |
...
| `query_cache_for_subqueries` | in v26.5.1.882 |  | Yes | If turned on, subquery results may be written to and read from the [query cache](../query-cache.md). This enables propagation of `use_query_cache` into all subqueries.\n\nPossible values:\n\n- 0 - Disabled\n- 1 - Enabled |
...
| `query_plan_fuse_filter_into_array_join` | in v26.9.1.1629 |  | Yes | Toggles a query-plan-level optimization which fuses a filter on `ARRAY JOIN`ed element columns into the `ARRAY JOIN` step, filtering the arrays in element space before expansion so that filtered-out elements are never expanded or replicated.\nOnly takes effect if setting [query_plan_enable_optimizations](#query_plan_enable_optimizations) is 1.\n\n<Note>\nThis is an expert-level setting which should only be used for debugging by developers. The setting may change in future in backward-incompatible ways or be removed.\n</Note> |
| `query_plan_join_shard_by_pk_ranges` | in v25.4.1.2934 |  | Yes | Apply sharding for JOIN if join keys contain a prefix of PRIMARY KEY for both tables. Supported for hash, parallel_hash and full_sorting_merge algorithms\n  |
...
| `query_plan_lower_array_join_function` | in v26.9.1.1629 |  | Yes | Toggles a query-plan-level optimization which lowers an `arrayJoin` function inside an expression into a real `ARRAY JOIN` step, so it goes through the same execution machinery as the `ARRAY JOIN` clause (lazy replication and filter fusion).\nOnly takes effect if setting [query_plan_enable_optimizations](#query_plan_enable_optimizations) is 1.\n\n:::note\nThis is an expert-level setting which should only be used for debugging by developers. The setting may change in future in backward-incompatible ways or be removed.\n::: |
| `query_plan_max_limit_for_join_lazy_indexing` | in v26.6.1.1193 |  | Yes | Control maximum limit value that allows to use query plan for lazy indexing optimization in JOIN. If zero, there is no limit. |
...
| `query_plan_max_limit_for_top_k_optimization` | in v25.12.1.649 |  | Yes | Control maximum limit value that allows to evaluate query plan for TopK optimization by using minmax skip index and dynamic threshold filtering. If zero, there is no limit. |
...
| `query_plan_max_set_size_for_projection_match` | in v26.6.1.1193 |  | Yes | Maximum number of rows in an `IN`-clause set for which the projection matcher computes and compares content hashes when deciding whether two sets are equal. Sets larger than this are treated as non-matching and skip the projection. Zero disables content-hash comparison entirely: a projection match never succeeds for nodes containing `IN`-clause sets.\n\nUsed by the aggregate projection matcher (and any future projection matcher that needs to compare `IN`-clause sets). Computing the content hash is `O(N log N)` in the number of set elements; this setting bounds the cost paid during planning when many `IN`-clauses appear in the query or the projection. |
| `query_plan_max_step_description_length` | in v25.9.2.1 |  | Yes | Maximum length of step description in EXPLAIN PLAN. |
| `query_plan_merge_expression_into_join` | in v26.7.1.1315 |  | Yes | Allow to merge expressions into JOIN step during join reordering optimization. |
...
| `query_plan_min_columns_for_join_lazy_indexing` | in v26.6.1.1193 |  | Yes | Control the minimum number of payload columns from the left side required for enabling lazy indexing optimization in JOIN. 0 means the optimization is disabled. |
| `query_plan_optimize_count_from_text_index` | in v26.8.1.2041 |  | Yes | Allow to answer `SELECT count() ... WHERE <text search predicate>` directly from the text index posting-list cardinalities, without materializing the matching rows.\nOnly takes effect when `query_plan_direct_read_from_text_index` is enabled. |
| `query_plan_optimize_join_order_algorithm` | in v25.12.1.649 |  | Yes | Specifies which JOIN order algorithms to attempt during query plan optimization. The following algorithms are available:\n - \'greedy\' - basic greedy algorithm - works fast but might not produce the best join order\n - \'dpsize\' - implements DPsize algorithm currently only for Inner joins - considers all possible join orders and finds the most optimal one but might be slow for queries with many tables and join predicates.\nMultiple algorithms can be specified, e.g. \'dpsize,greedy\'. |
| `query_plan_optimize_join_order_conflict_detector` | in v26.9.1.1629 |  | Yes | Only affects the `dpsub` join order algorithm. Selects the conflict detector that DPsub uses to\ndecide which join reorderings are valid. The following values are available:\n - `\'\'` (default) - no conflict detector, DPsub uses the per-relation `ON` clause restriction\n - `\'a\'` - the CD-A conflict detector, which is correct but incomplete\n - `\'c\'` - the CD-C conflict detector, which is correct and complete |
...
| `query_plan_optimize_join_order_max_searched_plans` | in v26.6.1.1193 |  | Yes | Maximum number of partial plans the join order optimizer may enumerate before giving up and falling back to the next algorithm in `query_plan_optimize_join_order_algorithm`.\nThis bounds optimization time deterministically (independent of wall-clock) on dense join graphs such as cliques or stars, where the search space grows exponentially.\nSet to 0 to disable the limit. Has no effect on the default `query_plan_optimize_join_order_limit`, where the search always stays well below this bound. |
| `query_plan_optimize_join_order_randomize` | in v26.4.1.1141 |  | Yes | When non-zero, the join order optimizer uses randomly generated cardinalities and NDVs instead of real statistics.\nWhen set to 1, a random seed is generated, when set to a value > 1, that value is used as the seed directly.\nThis is intended for testing to find errors caused by different join orderings. |
| `query_plan_optimize_lazy_final` | in v26.4.1.1141 |  | Yes | Optimize reading with FINAL from ReplacingMergeTree by building a set of primary keys and using it for index analysis. |
| `query_plan_optimize_lazy_materialization` | in v25.4.1.2934 |  | Yes | Use query plan for lazy materialization optimization |
| `query_plan_optimize_lazy_materialization_for_file` | in v26.8.1.2041 |  | Yes | Use lazy materialization optimization for reading local Parquet files with the `file` table function and the `File` table engine: for `ORDER BY ... LIMIT n` queries, the columns that are not needed for sorting and filtering are read only for the `n` rows that survive the `LIMIT`. Takes effect only if `query_plan_optimize_lazy_materialization` is enabled. |
| `query_plan_optimize_lazy_materialization_for_object_storage` | in v26.8.1.2041 |  | Yes | Use lazy materialization optimization for reading Parquet files from object storage (including Iceberg tables): for `ORDER BY ... LIMIT n` queries, the columns that are not needed for sorting and filtering are read only for the `n` rows that survive the `LIMIT`. Takes effect only if `query_plan_optimize_lazy_materialization` is enabled. |
...
| `query_plan_remove_unused_columns` | in v25.12.1.649 |  | Yes | Toggles a query-plan-level optimization which tries to remove unused columns (both input and output columns) from query plan steps.\nOnly takes effect if setting [query_plan_enable_optimizations](#query_plan_enable_optimizations) is 1.\n\n:::note\nThis is an expert-level setting which should only be used for debugging by developers. The setting may change in future in backward-incompatible ways or be removed.\n:::\n\nPossible values:\n\n- 0 - Disable\n- 1 - Enable |
...
| `query_plan_short_circuit_constant_false_join` | in v26.8.1.2041 |  | Yes | Short-circuit a `JOIN` whose `ON` condition folds to a constant false by replacing each input side that cannot contribute a row (both sides for `INNER`/`CROSS`/`SEMI`, the non-preserved side for `LEFT`/`RIGHT`) with an empty source, so the non-contributing side is not read. Applies to the analyzer (`enable_analyzer = 1`) and to non-distributed plans. |
| `query_plan_split_filter` | in v23.11.1.2711 |  | Yes | Allow to split filters in the query plan |
| `query_plan_text_index_add_hint` | in v25.12.1.649 |  | Yes | Allow to add hint (additional predicate) for filtering built from the inverted text index in query plan. |
| `query_plan_top_k_through_join` | in v26.5.1.882 |  | Yes | Toggles a query-plan-level optimization which pushes `ORDER BY ... LIMIT n` down through a join when the sort key only references columns from the side preserved by the join (LEFT/RIGHT). Restricts how many rows the preserved-side input must produce before joining.\nOnly takes effect if setting [query_plan_enable_optimizations](#query_plan_enable_optimizations) is 1.\n\nPossible values:\n\n- 0 - Disable\n- 1 - Enable |
...
| `query_plan_use_logical_join_step` | in v25.10.1.3832 | in v26.5.1.882 | Yes | Use logical join step in query plan.\nNote: setting `query_plan_use_new_logical_join_step` is deprecated, use `query_plan_use_logical_join_step` instead. |
| `query_plan_use_new_logical_join_step` | in v25.1.1.4165 | in v26.5.1.882 | Yes | Use new logical join step in query plan |
...
| `reader_executor_block_size` | in v26.8.1.2041 |  | Yes | Buffer chunk size for the experimental `ReaderExecutor`: source reads fill nodes of at most this size. Must be at least 4 KiB. |
| `reader_executor_max_tail_for_drain` | in v26.7.1.1315 |  | Yes | Drain bound for the experimental `ReaderExecutor`: a long source connection dropped within this many bytes of its right bound is read out to the bound first, so it completes and returns to the connection pool reusable instead of counting as an incomplete connection. |
| `reader_executor_min_bytes_for_seek` | in v26.7.1.1315 |  | Yes | Forward-gap bound for the experimental `ReaderExecutor`: a gap up to this is skipped on the open source connection (bridged / read through) instead of issuing a separate source read or reopening. Set near the bandwidth/request cost breakeven so bridging stays cost-positive. |
| `reader_executor_use_long_connections` | in v26.7.1.1315 |  | Yes | Reuse a bounded long source connection across windows in the experimental `ReaderExecutor`. A long connection is one whose range exceeds the current read window; when disabled, the executor takes no connection-pool budget and every window opens a short-lived one-shot connection (the stateless path). |
| `reader_executor_window_size` | in v26.8.1.2041 |  | Yes | Bytes served per read window by the experimental `ReaderExecutor` (the unit a read returns). Must be at least 4 KiB. |
...
| `s3_path_filter_limit` | in v25.12.1.649 |  | Yes | Maximum number of `_path` values that can be extracted from query filters to use for file iteration\ninstead of glob listing. 0 means disabled. |
...
| `s3_uri_style` | in v26.4.1.1141 |  | Yes | Force the s3 endpoint style. Possible values: auto, virtual_hosted, path. |
...
| `secondary_indices_enable_bulk_filtering` | in v25.5.1.2782 |  | Yes | Enable the bulk filtering algorithm for indices. It is expected to be always better, but we have this setting for compatibility and control. |
| `select` | in v26.8.1.2041 |  | Yes | Wraps the query as a subquery with an explicit `SELECT` expression list. When non-empty, the result-producing query is wrapped as `SELECT <expr_list> FROM (<query>)`.\n\nThis is a query-construction setting applied by the engine on the parsed query (wrapping it as a derived table), so it composes with the existing query and works on every protocol: it can be supplied via the HTTP URL parameter, an in-query `SETTINGS` clause, or a user profile.\n\nIt shapes result-producing `SELECT` / `UNION` queries. For a write query (`INSERT … SELECT`, `CREATE … AS SELECT`) it takes effect only when the source `SELECT` carries it in its own `SETTINGS` clause; a value inherited from a profile or session, or set on the `INSERT` / `CREATE` statement itself, does not propagate into the source `SELECT` — the same non-propagation rule that applies to any other setting. |
...
| `send_profile_events` | in v25.11.1.558 |  | Yes | Enables or disables sending of [ProfileEvents](/native-protocol/server.md#profile-events) packets to the client.\n\nThis can be disabled to reduce network traffic for clients that do not require profile events.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled. |
| `send_progress_in_http_headers` | in v1.1.54180 |  | Yes | Send progress notifications using X-ClickHouse-Progress headers. |
| `send_table_structure_on_insert_with_inline_data` | in v26.5.1.882 |  | Yes | If disabled and the INSERT query contains inline data, the server will not send the table structure and column defaults back to the client over the native protocol. Instead, the server will parse the inline data itself. This can improve performance for many small inserts over the native protocol. |
| `send_timeout` | in v1.1.54019 |  | Yes |  |
| `serialize_query_plan` | in v25.4.1.2934 |  | Yes | Serialize query plan for distributed processing |
| `serialize_string_in_memory_with_zero_byte` | in v25.8.13.73 |  | Yes | Serialize String values during aggregation with zero byte at the end. Enable to keep compatibility when querying cluster of incompatible versions. |
| `session_query_ids_history_size` | in v26.9.1.1629 |  | Yes | The maximum number of query ids kept in the session-local history exposed through the [`system.session_query_ids`](/operations/system-tables/session_query_ids) system table.\nThe query id of every non-internal query executed in the session is recorded there at query start; when the history exceeds this size, the oldest entries are evicted first.\n\nThe value is read at query start, before the query is parsed, so a `SETTINGS` clause of the query itself does not affect whether that query is recorded; use `SET`, an HTTP URL parameter, or a settings profile instead.\n\nPossible values:\n\n- Positive integer.\n- 0 — Recording is disabled; entries recorded earlier stay in the table. |
...
| `shared_merge_tree_sequential_consistency_initial_parts_update_backoff_ms` | in v26.5.1.882 |  | Yes | Initial backoff in milliseconds for parts update when using `select_sequential_consistency` with `SharedMergeTree`. Only available in ClickHouse Cloud. |
| `shared_merge_tree_sequential_consistency_max_parts_update_backoff_ms` | in v26.5.1.882 |  | Yes | Max backoff in milliseconds for parts update when using `select_sequential_consistency` with `SharedMergeTree`. Only available in ClickHouse Cloud. |
| `shared_merge_tree_sequential_consistency_parts_update_max_retries` | in v26.5.1.882 |  | Yes | Max retries for parts update when using `select_sequential_consistency` with `SharedMergeTree`. Only available in ClickHouse Cloud. |
...
| `show_processlist_include_internal` | in v25.11.1.558 |  | Yes | Show internal auxiliary processes in the `SHOW PROCESSLIST` query output.\n\nInternal processes include dictionary reloads, refreshable materialized view reloads, auxiliary `SELECT`s executed in `SHOW ...` queries, auxiliary `CREATE DATABASE ...` queries executed internally to accommodate broken tables and more.\n     |
| `show_remote_databases_in_system_tables` | in v26.3.13.31 |  | Yes | Enables showing remote databases (data lake catalogs, MySQL, PostgreSQL) in system tables. |
...
| `shrink_over_allocated_columns_min_waste_bytes` | in v26.8.1.2041 |  | Yes | Minimum absolute amount of wasted (reserved but unused) memory in a column, in bytes, for it to be shrunk to fit on INSERT. See [shrink_over_allocated_columns_min_waste_ratio](#shrink_over_allocated_columns_min_waste_ratio).\n\nPrevents reallocating columns whose over-allocation is small, where the memory saving would not justify the cost. |
| `shrink_over_allocated_columns_min_waste_ratio` | in v26.8.1.2041 |  | Yes | On INSERT, over-allocated columns (whose reserved memory exceeds the used memory, e.g. due to power-of-two growth of variable-length columns) are shrunk to fit before the expensive materialization and part-writing stages, to reduce peak memory usage.\n\nA column is shrunk only when `allocatedBytes() > byteSize() * shrink_over_allocated_columns_min_waste_ratio` and the absolute waste is at least `shrink_over_allocated_columns_min_waste_bytes`.\n\nPossible values:\n\n- Float greater than 1.\n- Value less than or equal to 1 disables the shrinking (the default `1.0` keeps it disabled). |
...
| `text_index_density_threshold` | in v26.6.1.1193 |  | Yes | Density threshold for algorithm selection in lazy posting list mode.\nBelow threshold: leapfrog intersection. At or above: brute-force bitmap. |
| `text_index_hint_max_selectivity` | in v25.12.1.649 |  | Yes | Maximal selectivity of the filter to use the hint built from the inverted text index. |
| `text_index_lazy_intersection_density_threshold` | in v26.7.1.1315 |  | Yes | Posting list density threshold that selects the intersection algorithm in lazy posting list apply mode (`text_index_posting_list_apply_mode = \'lazy\'`).\nBelow the threshold: leapfrog intersection (favors sparse posting lists). At or above: brute-force bitmap intersection (favors dense posting lists). |
| `text_index_like_max_postings_to_read` | in v26.4.1.1141 |  | Yes | Maximum number of large postings to read when text index LIKE evaluation by the dictionary scan is enabled.\n\nRequires `use_text_index_like_evaluation_by_dictionary_scan` to be enabled. |
| `text_index_like_min_pattern_length` | in v26.4.1.1141 |  | Yes | Minimum length of the alphanumeric needle in a LIKE/ILIKE pattern required to use the text index LIKE evaluation by the dictionary scan.\nPatterns shorter than this threshold match too many dictionary tokens and are skipped to avoid expensive scans.\n\nRequires `use_text_index_like_evaluation_by_dictionary_scan` to be enabled. |
| `text_index_posting_list_apply_mode` | in v26.6.1.1193 |  | Yes | Controls how posting lists are applied during text index queries.\n\'materialize\' (default) eagerly decodes posting lists into Roaring Bitmaps.\n\'lazy\' uses cursor-based on-demand decoding (requires V2 index format and allow_experimental_text_index_lazy_apply). |
| `text_index_use_bloom_filter` | in v25.9.2.1 | in v26.2.1.1139 | Yes | For testing purposes, enables or disables usage of bloom filter in text index. |
| `throw_if_deduplication_in_dependent_materialized_views_enabled_with_async_insert` | in v24.3.1.2672 | in v26.1.1.912 | Yes | Throw exception on INSERT query when the setting `deduplicate_blocks_in_dependent_materialized_views` is enabled along with `async_insert`. It guarantees correctness, because these features can\'t work together. |
...
| `throw_on_hive_partitioning_resolution_failure` | in v26.3.20.7 |  | Yes | Throw an exception instead of logging a warning when Hive-style partitioning detection for an object storage table fails to list the storage. When disabled, the query runs without the Hive partition columns, which may change its result. |
...
| `type_json_allow_duplicated_key_with_literal_and_nested_object` | in v26.1.1.912 |  | Yes | When enabled, JSONs like `{"a" : 42, "a" : {"b" : 42}}` where some key is duplicated but one of them is a nested object are allowed to be parsed. |
...
| `type_json_skip_invalid_typed_paths` | in v25.12.1.649 |  | Yes | When enabled, fields with values that cannot be coerced to their declared type in JSON type columns with typed paths are skipped instead of throwing an error. Skipped fields are treated as missing and will use default/null values based on the typed path definition.\n\nThis setting only applies to JSON type columns (e.g., JSON(a Int64, b String)) where specific paths have declared types. It does not apply to regular JSON input formats like JSONEachRow when inserting into regular typed columns.\n\nPossible values:\n\n+ 0 — Disable (throw error on type mismatch).\n+ 1 — Enable (skip field on type mismatch). |
| `type_json_skip_null_typed_paths` | in v26.9.1.1629 |  | Yes | When enabled, typed paths in JSON columns that have NULL values are treated as absent, matching the behavior of dynamic paths. This affects JSON serialization output, introspection functions like `JSONAllPaths`, `JSONHas`, `JSONExtractRaw`, `has`, and `empty`/`notEmpty` checks.\n\nPossible values:\n\n+ 0 — Disable (typed paths are always present, even with NULL values).\n+ 1 — Enable (NULL typed paths are treated as absent). |
| `type_json_use_partial_match_to_skip_paths_by_regexp` | in v26.1.1.912 |  | Yes | When enabled, during parsing JSON object into JSON type regular expressions specified using SKIP REGEXP will require partial match to skip a path. When disabled, full match will be required. |
...
| `unique_key_max_encoded_size` | in v26.6.1.1193 |  | Yes | Maximum size (in bytes) of the order-preserving binary encoding of a single `UNIQUE KEY` row. |
| `unique_key_probe_implementation` | in v26.8.1.2041 |  | Yes | Selects the UNIQUE KEY write-path probe implementation. Currently only a single-threaded\nbaseline exists, so `auto` and `simple` both resolve to it.\n\nReserved: this setting has no effect yet — the value is not read until the UNIQUE KEY INSERT\nwrite path that constructs the probe is wired up. Declared now so the lever ships with the\nimplementation. |
...
| `use_iceberg_manifest_list_partition_pruning` | in v26.9.1.1629 |  | Yes | Skip whole Iceberg manifest files whose partition summaries in the manifest list cannot match the query filter, without reading them. Requires [use_iceberg_partition_pruning](#use_iceberg_partition_pruning) to be enabled and only helps when a manifest file holds few distinct partition values, which is what `rewriteManifests` clustered by the partition columns produces. |
| `use_iceberg_metadata_files_cache` | in v25.4.1.2934 |  | Yes | If turned on, iceberg table function and iceberg storage may utilize the iceberg metadata files cache. |
...
| `use_json_alias_for_old_object_type` | in v24.8.1.2684 | in v25.11.1.558 | Yes | When enabled, JSON type alias will create old experimental Object type instead of a new JSON type |
...
| `use_page_cache_for_local_disks` | in v26.2.1.1139 |  | Yes | Use userspace page cache when reading from local disks. Used for testing, unlikely to improve performance in practice. Requires local_filesystem_read_method = \'pread\' or \'read\'. Doesn\'t disable the OS page cache; min_bytes_to_use_direct_io can be used for that. Only affects regular tables, not file() table function or File() table engine. |
| `use_page_cache_for_object_storage` | in v26.2.1.1139 |  | Yes |     Use userspace page cache when reading from object storage table functions (s3, azure, hdfs) and table engines (S3, Azure, HDFS).\n     |
| `use_page_cache_with_distributed_cache` | in v25.3.1.2703 |  | Yes | Use userspace page cache when distributed cache is used. |
| `use_paimon_metadata_files_cache` | in v26.7.1.1315 |  | Yes | If turned on, paimon table function and paimon storage may utilize the paimon metadata files cache.\n\nPaimon table functions evaluate this setting per query, while persistent Paimon table engines latch it at metadata initialization: to change the decision for an already-created table, it must be dropped and recreated.\n\nPossible values:\n\n- 0 - Disabled\n- 1 - Enabled |
| `use_paimon_partition_pruning` | in v25.12.1.649 |  | Yes | Use Paimon partition pruning for Paimon table functions |
| `use_parquet_metadata_cache` | in v26.3.1.896 |  | Yes | If turned on, parquet format may utilize the parquet metadata cache.\n\nPossible values:\n\n- 0 - Disabled\n- 1 - Enabled |
| `use_partition_key` | in v26.3.1.896 |  | Yes | Use partition key to prune partitions during query execution for MergeTree tables.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled. |
| `use_partition_minmax_for_primary_key_pruning` | in v26.7.1.1315 |  | Yes | Use partition minmax index bounds to prune more granules during primary key analysis for `MergeTree` tables, when a primary key column is also an input column of the partition key.\n\nFor example, in a `MergeTree` table with `ORDER BY (id, event_time)` and `PARTITION BY toYYYYMM(event_time)`, ClickHouse will use the partition minmax index on `event_time` during primary key index analysis to make more informed granule-pruning decisions.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled. |
| `use_partition_pruning` | in v26.3.1.896 |  | Yes | Use partition key to prune partitions during query execution for MergeTree tables.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled. |
| `use_primary_key` | in v26.1.1.912 |  | Yes | Use the primary key to prune granules during query execution for MergeTree tables.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled. |
| `use_projection_index_in_read_pools` | in v26.8.1.2041 | in v26.8.1.2041 | Yes | Obsolete setting, does nothing. |
...
| `use_query_condition_cache_for_top_k` | in v26.7.2.59 |  | Yes | Enable the [query condition cache](/operations/query-condition-cache) for queries that use the `ORDER BY <column> LIMIT n` (TopK) optimization (dynamic filtering or skip-index based). When disabled, such reads neither consult nor populate the cache.\n\nSuch queries can drop granules during execution depending on the running threshold, so their cache entries are partitioned by the TopK plan parameters and by the set of parts read. This setting is disabled by default while the soundness of these cache entries is being established; it has no effect unless `use_query_condition_cache` is also enabled.\n\nPossible values:\n\n- 0 - Disabled\n- 1 - Enabled |
| `use_reader_executor` | in v26.6.1.1193 |  | Yes | Experimental. Route reads through the new pipeline `ReaderExecutor` instead of the legacy matryoshka of read buffers. Falls back to the legacy path for configurations the executor does not yet support. |
| `use_roaring_bitmap_iceberg_positional_deletes` | in v25.8.1.5101 |  | Yes | Use roaring bitmap for iceberg positional deletes. |
| `use_skip_indexes` | in v21.11.2.2 |  | Yes | Use data skipping indexes during query execution. |
| `use_skip_indexes_for_disjunctions` | in v25.12.1.649 |  | Yes | Evaluate WHERE filters with mixed AND and OR conditions using skip indexes. Example: WHERE A = 5 AND (B = 5 OR C = 5).\nIf disabled, skip indexes are still used to evaluate WHERE conditions but they must only contain AND-ed clauses.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled. |
| `use_skip_indexes_for_top_k` | in v25.12.1.649 |  | Yes | Enable using data skipping indexes for TopK filtering.\n\nWhen enabled, if a minmax skip index exists on the column in `ORDER BY <column> LIMIT n` query, optimizer will attempt to use the minmax index to skip granules that are not relevant for the final result . This can reduce query latency.\n\nPossible values:\n\n- 0 — Disabled.\n- 1 — Enabled. |
...
| `use_variant_default_implementation_for_comparisons` | in v26.1.1.912 |  | Yes | Enables or disables default implementation for Variant type in comparison functions. |
...
| `variant_throw_on_type_mismatch` | in v26.3.14.49 |  | Yes | When applying a function to a [Variant](../../sql-reference/data-types/variant.md) column using the default implementation,\ncontrols what happens for rows whose actual type is incompatible with the function:\n- `true` (default) — throw an exception.\n- `false` — return `NULL` for those rows instead. |
| `vector_search_filter_strategy` | in v25.5.1.2782 |  | Yes | If a vector search query has a WHERE clause, this setting determines if it is evaluated first (pre-filtering) OR if the vector similarity index is checked first (post-filtering). Possible values:\n- \'auto\' - Postfiltering (the exact semantics may change in future).\n- \'postfilter\' - Use vector similarity index to identify the nearest neighbours, then apply other filters\n- \'prefilter\' - Evaluate other filters first, then perform brute-force search to identify neighbours. |
| `vector_search_index_fetch_multiplier` | in v25.8.1.5101 |  | Yes | Multiply the number of fetched nearest neighbors from the vector similarity index by this number. Only applied for post-filtering with other predicates or if setting \'vector_search_with_rescoring = 1\'. |
| `vector_search_postfilter_multiplier` | in v25.5.1.2782 |  | Yes | Multiply the fetched nearest neighbors from the vector similarity index by this number before performing post-filtering on other predicates. |
| `vector_search_use_quantized_codes` | in v26.7.1.1315 |  | Yes | Enables a two-stage approximate vector search without index (brute force scan) over a `Quantized`-compressed column. When enabled, `ORDER BY L2Distance|cosineDistance(vec, reference) LIMIT k` against a column encoded with a `Quantized(...)` codec will\n1. scan and filter the quantized vectors (this step produces `k * vector_search_index_fetch_multiplier` results), and\n2. rescore the found vectors against original, full-precision vectors. |
| `vector_search_with_rescoring` | in v25.8.1.5101 |  | Yes | If ClickHouse performs rescoring for queries that use the vector similarity index.\nWithout rescoring, the vector similarity index returns the rows containing the best matches directly.\nWith rescoring, the rows are extrapolated to granule level and all rows in the granule are checked again.\nIn most situations, rescoring helps only marginally with accuracy but it deteriorates performance of vector search queries significantly.\nNote: A query run without rescoring and with parallel replicas enabled may fall back to rescoring. |
...
| `write_through_distributed_cache_buffer_size` | in v25.7.1.3997 |  | Yes | Only has an effect in ClickHouse Cloud. Set buffer size for write-through distributed cache. If 0, will use buffer size which would have been used if there was not distributed cache. |
...
| `add_minmax_index_for_block_number_column` | in v26.5.1.882 | Yes | `0` from `26.5.1.882` to `latest` |
| `add_minmax_index_for_block_offset_column` | in v26.5.1.882 | Yes | `0` from `26.5.1.882` to `latest` |
...
| `add_minmax_index_for_temporal_columns` | in v26.2.1.1139 | Yes | `0` from `26.2.1.1139` to `latest` |
| `allow_coalescing_columns_in_partition_or_order_key` | in v25.6.1.3206 | Yes | `0` from `25.6.1.3206` to `latest` |
| `allow_commit_order_projection` | in v26.4.1.1141 | Yes | `0` from `26.4.1.1141` to `latest` |
| `allow_dimensions_outside_sorting_key` | in v26.7.1.1315 | Yes | `0` from `26.7.1.1315` to `latest` |
| `allow_experimental_block_number_column` | in v23.9.1.1854 | up to v24.3.18.10426.altinitystable | `0` from `23.9.1.1854` to `24.3.18.10426` |
...
| `allow_experimental_text_index_phrase_search` | in v26.7.1.1315 | Yes | `0` from `26.7.1.1315` to `latest` |
| `allow_experimental_text_index_positions` | in v26.6.1.1193 | up to v26.6.8.7 | `0` from `26.6.1.1193` to `26.6.8.7` |
| `allow_floating_point_partition_key` | in v21.2.2.8 | Yes | `0` from `21.2.2.8` to `latest` |
| `allow_minmax_index_for_json` | in v26.7.1.1315 | Yes | `0` from `26.7.1.1315` to `latest` |
| `allow_nullable_key` | in v20.7.2.30 | Yes | `0` from `20.7.2.30` to `latest` |
| `allow_part_offset_column_in_projections` | in v25.8.1.5101 | Yes | `1` from `25.8.1.5101` to `latest` |
...
| `allow_summing_columns_in_partition_or_order_key` | in v25.4.1.2934 | Yes | `0` from `25.4.1.2934` to `latest` |
| `allow_suspicious_indices` | in v23.4.1.1943 | Yes | `0` from `23.4.1.1943` to `latest` |
| `allow_tuple_element_aggregation` | in v26.6.1.1193 | Yes | `0` from `26.6.1.1193` to `latest` |
...
| `alter_column_secondary_index_mode` | in v25.12.1.649 | Yes | `rebuild` from `25.12.1.649` to `latest` |
| `always_fetch_merged_part` | in v20.4.2.9 | Yes | `0` from `20.4.2.9` to `latest` |
| `always_fetch_mutated_part` | in v26.8.1.2041 | Yes | `0` from `26.8.1.2041` to `latest` |
| `always_use_copy_instead_of_hardlinks` | in v23.12.1.1368 | Yes | `0` from `23.12.1.1368` to `latest` |
| `apply_patches_on_merge` | in v25.5.1.2782 | Yes | `1` from `25.5.1.2782` to `latest` |
...
| `auto_statistics_types` | in v25.10.1.3832 | Yes | `` from `25.10.1.3832` to `26.3.33.10001` / `basic /  uniq_v2` from `26.7.1.1315` to `latest` / `minmax /  uniq` from `26.4.1.1141` to `26.6.8.7` |
...
| `clone_replica_zookeeper_create_get_part_batch_size` | in v26.2.1.1139 | Yes | `100` from `26.2.1.1139` to `latest` |
...
| `compress_per_column_in_compact_parts` | in v26.4.1.1141 | Yes | `1` from `26.4.1.1141` to `latest` |
| `compress_primary_key` | in v22.9.1.2603 | Yes | `0` from `22.9.1.2603` to `23.4.6.25` / `1` from `23.5.1.3174` to `latest` |
| `compute_exact_num_defaults_for_sparse_columns` | in v26.7.1.1315 | Yes | `0` from `26.7.1.1315` to `26.7.13.12` / `1` from `26.8.1.2041` to `latest` |
| `concurrent_part_removal_threshold` | in v19.14.3.3 | Yes | `100` from `19.14.3.3` to `latest` |
| `concurrent_part_removal_threshold_for_remote_disk` | in v26.5.1.882 | Yes | `16` from `26.5.1.882` to `latest` |
| `dead_blobs_to_delay_insert` | in v26.7.1.1315 | Yes | `100000` from `26.7.1.1315` to `latest` |
| `dead_blobs_to_throw_insert` | in v26.7.1.1315 | Yes | `1000000` from `26.7.1.1315` to `latest` |
| `deduplicate_merge_projection_mode` | in v24.8.1.2684 | Yes | `throw` from `24.8.1.2684` to `latest` |
| `deduplication_hashes_cache_update_wait_ms` | in v26.7.1.1315 | Yes | `100` from `26.7.1.1315` to `latest` |
| `default_compression_codec` | in v25.4.1.2934 | Yes | `` from `25.4.1.2934` to `latest` |
...
| `distributed_index_analysis_min_indexes_bytes_to_activate` | in v26.2.1.1139 | Yes | `1073741824` from `26.2.1.1139` to `latest` |
| `distributed_index_analysis_min_parts_to_activate` | in v26.2.1.1139 | Yes | `10` from `26.2.1.1139` to `latest` |
| `dynamic_serialization_version` | in v25.8.1.5101 | Yes | `v2` from `25.8.1.5101` to `25.12.1.649` / `v3` from `25.12.2.54` to `latest` |
| `enable_adaptive_codec_selection` | in v26.8.1.2041 | Yes | `0` from `26.8.1.2041` to `latest` |
...
| `enable_max_bytes_limit_for_min_age_to_force_merge` | in v24.3.15.72 | Yes | `0` from `24.3.15.72` to `26.1.12.23` / `1` from `26.2.1.1139` to `latest` |
...
| `escape_index_filenames` | in v26.1.1.912 | Yes | `1` from `26.1.1.912` to `latest` |
| `escape_variant_subcolumn_filenames` | in v25.11.1.558 | Yes | `1` from `25.11.1.558` to `latest` |
...
| `map_buckets_coefficient` | in v26.3.2.3 | Yes | `1` from `26.3.2.3` to `latest` |
| `map_buckets_min_avg_size` | in v26.3.2.3 | Yes | `32` from `26.3.2.3` to `latest` |
| `map_buckets_strategy` | in v26.3.2.3 | Yes | `sqrt` from `26.3.2.3` to `latest` |
| `map_serialization_version` | in v26.3.2.3 | Yes | `basic` from `26.3.2.3` to `latest` |
| `map_serialization_version_for_zero_level_parts` | in v26.3.2.3 | Yes | `basic` from `26.3.2.3` to `latest` |
...
| `materialize_projections_on_insert` | in v26.6.1.1193 | Yes | `1` from `26.6.1.1193` to `latest` |
| `materialize_projections_on_merge` | in v26.6.1.1193 | Yes | `0` from `26.6.1.1193` to `latest` |
| `materialize_skip_indexes_on_merge` | in v25.1.1.4165 | Yes | `1` from `25.1.1.4165` to `latest` |
| `materialize_statistics_on_merge` | in v26.1.1.912 | Yes | `1` from `26.1.1.912` to `latest` |
...
| `max_buckets_in_map` | in v26.3.2.3 | Yes | `32` from `26.3.2.3` to `latest` |
...
| `max_merge_delayed_streams_for_parallel_write` | in v25.4.1.2934 | Yes | `40` from `25.4.1.2934` to `latest` |
...
| `max_part_loading_threads` | in v19.14.3.3 | Yes | `\\auto(12)\\` from `22.10.7.13` to `26.3.9.8` / `\\auto(24)\\` from `24.8.14.10546` to `24.8.14.10548` / `\\auto(32)\\` from `25.3.14.10001` to `26.6.8.7` / `\\auto(4)\\` from `20.7.2.30` to `22.9.7.34` / `\\auto(6)\\` from `22.3.18.37` to `22.8.21.38` / `\\auto(8)\\` from `22.10.1.1877` to `22.12.3.5` / `auto(32)` from `26.7.1.1315` to `latest` / `auto(4)` from `19.14.3.3` to `20.6.11.1` |
| `max_part_removal_threads` | in v19.14.3.3 | Yes | `\\auto(12)\\` from `22.10.7.13` to `26.3.9.8` / `\\auto(24)\\` from `24.8.14.10546` to `24.8.14.10548` / `\\auto(32)\\` from `25.3.14.10001` to `26.6.8.7` / `\\auto(4)\\` from `20.7.2.30` to `22.9.7.34` / `\\auto(6)\\` from `22.3.18.37` to `22.8.21.38` / `\\auto(8)\\` from `22.10.1.1877` to `22.12.3.5` / `auto(32)` from `26.7.1.1315` to `latest` / `auto(4)` from `19.14.3.3` to `20.6.11.1` |
...
| `max_postpone_time_for_failed_replicated_fetches_ms` | in v25.4.1.2934 | Yes | `60000` from `25.4.1.2934` to `latest` |
| `max_postpone_time_for_failed_replicated_merges_ms` | in v25.4.1.2934 | Yes | `60000` from `25.4.1.2934` to `latest` |
| `max_postpone_time_for_failed_replicated_tasks_ms` | in v25.4.1.2934 | Yes | `300000` from `25.4.1.2934` to `latest` |
...
| `max_table_size_bytes_compressed` | in v26.9.1.1629 | Yes | `0` from `26.9.1.1629` to `latest` |
| `max_table_size_bytes_uncompressed` | in v26.9.1.1629 | Yes | `0` from `26.9.1.1629` to `latest` |
| `max_table_size_rows` | in v26.9.1.1629 | Yes | `0` from `26.9.1.1629` to `latest` |
| `max_uncompressed_bytes_in_patches` | in v25.8.1.5101 | Yes | `32212254720` from `25.8.1.5101` to `latest` |
...
| `merge_max_dynamic_subcolumns_in_compact_part` | in v26.1.1.912 | Yes | `auto` from `26.1.1.912` to `latest` |
| `merge_max_dynamic_subcolumns_in_wide_part` | in v25.8.14.17 | Yes | `auto` from `25.8.14.17` to `latest` |
...
| `merge_selector_enable_heuristic_to_lower_max_parts_to_merge_at_once` | in v25.12.1.649 | Yes | `0` from `25.12.1.649` to `26.6.8.7` / `1` from `26.7.1.1315` to `latest` |
| `merge_selector_enable_heuristic_to_remove_small_parts_at_right` | in v24.11.1.2557 | Yes | `1` from `24.11.1.2557` to `latest` |
| `merge_selector_heuristic_to_lower_max_parts_to_merge_at_once_exponent` | in v25.12.1.649 | Yes | `5` from `25.12.1.649` to `latest` |
...
| `merge_use_batch_sorting_queue` | in v26.8.1.2041 | Yes | `0` from `26.8.1.2041` to `latest` |
...
| `min_columns_to_activate_adaptive_write_buffer` | in v25.8.16.10001.altinitystable | Yes | `500` from `25.8.16.10001` to `latest` |
...
| `min_partition_age_to_force_merge_seconds` | in v26.9.1.1629 | Yes | `0` from `26.9.1.1629` to `latest` |
...
| `nullable_serialization_version` | in v25.12.1.649 | Yes | `basic` from `25.12.1.649` to `latest` |
...
| `object_serialization_version` | in v25.8.1.5101 | Yes | `v2` from `25.8.1.5101` to `25.12.1.649` / `v3` from `25.12.2.54` to `latest` |
| `object_shared_data_buckets_for_compact_part` | in v25.8.1.5101 | Yes | `8` from `25.8.1.5101` to `latest` |
| `object_shared_data_buckets_for_wide_part` | in v25.8.1.5101 | Yes | `32` from `25.8.1.5101` to `latest` |
| `object_shared_data_serialization_version` | in v25.8.1.5101 | Yes | `advanced` from `25.12.2.54` to `latest` / `map` from `25.8.1.5101` to `25.12.1.649` |
| `object_shared_data_serialization_version_for_zero_level_parts` | in v25.8.1.5101 | Yes | `map` from `25.8.1.5101` to `25.12.1.649` / `map_with_buckets` from `25.12.2.54` to `latest` |
| `object_shared_data_target_chunk_rows` | in v26.9.1.1629 | Yes | `8192` from `26.9.1.1629` to `latest` |
...
| `packed_skip_index_max_bytes` | in v26.6.1.1193 | Yes | `0` from `26.6.1.1193` to `26.7.13.12` / `1048576` from `26.8.1.2041` to `latest` |
| `part_minmax_index_columns` | in v26.5.1.882 | Yes | `partition_key_only` from `26.5.1.882` to `latest` |
...
| `patch_parts_version` | in v26.8.1.2041 | Yes | `v2` from `26.8.1.2041` to `latest` |
...
| `propagate_types_serialization_versions_to_nested_types` | in v26.3.1.896 | Yes | `1` from `26.3.1.896` to `latest` |
...
| `refresh_parts_interval` | in v25.4.1.2934 | Yes | `0` from `25.4.1.2934` to `latest` |
| `refresh_statistics_interval` | in v25.11.1.558 | Yes | `0` from `25.11.1.558` to `26.1.12.23` / `300` from `26.2.1.1139` to `latest` |
...
| `replicated_deduplication_window` | in v18.10.3 | Yes | `100` from `18.10.3.0` to `23.10.6.60` / `1000` from `23.11.1.2711` to `25.8.33.6` / `10000` from `25.9.2.1` to `latest` |
...
| `replicated_fetches_min_part_level` | in v26.4.1.1141 | Yes | `0` from `26.4.1.1141` to `latest` |
| `replicated_fetches_min_part_level_timeout_seconds` | in v26.4.1.1141 | Yes | `300` from `26.4.1.1141` to `latest` |
...
| `serialization_info_version` | in v25.10.1.3832 | Yes | `basic` from `25.10.1.3832` to `25.10.7.6` / `with_types` from `25.11.1.558` to `latest` |
| `share_nested_offsets` | in v26.4.1.1141 | Yes | `1` from `26.4.1.1141` to `latest` |
| `shared_merge_tree_activate_coordinated_merges_tasks` | in v25.10.1.3832 | Yes | `0` from `25.10.1.3832` to `latest` |
| `shared_merge_tree_blobs_list_inline_file_max_bytes` | in v26.8.1.2041 | Yes | `0` from `26.8.1.2041` to `latest` |
| `shared_merge_tree_create_per_replica_metadata_nodes` | in v25.1.1.4165 | Yes | `0` from `25.11.1.558` to `latest` / `1` from `25.1.1.4165` to `25.10.7.6` |
...
| `shared_merge_tree_enable_automatic_empty_partitions_cleanup` | in v25.9.2.1 | Yes | `0` from `25.9.2.1` to `26.1.12.23` / `1` from `26.2.1.1139` to `latest` |
| `shared_merge_tree_enable_coordinated_merges` | in v25.5.1.2782 | Yes | `0` from `25.5.1.2782` to `26.5.7.64` / `1` from `26.6.1.1193` to `latest` |
| `shared_merge_tree_enable_keeper_parts_extra_data` | in v25.3.1.2703 | Yes | `0` from `25.3.1.2703` to `26.5.7.64` / `1` from `26.6.1.1193` to `latest` |
...
| `shared_merge_tree_inactive_replica_cutoff_seconds` | in v26.6.1.1193 | Yes | `0` from `26.6.1.1193` to `latest` |
...
| `shared_merge_tree_merge_coordinator_distribution_algorithm` | in v26.7.1.1315 | Yes | `sainte_lague` from `26.8.1.2041` to `latest` / `water_filling` from `26.7.1.1315` to `26.7.13.12` |
| `shared_merge_tree_merge_coordinator_election_check_period_ms` | in v25.5.1.2782 | Yes | `30000` from `25.5.1.2782` to `latest` |
| `shared_merge_tree_merge_coordinator_factor` | in v25.5.1.2782 | Yes | `1.1` from `25.10.1.3832` to `latest` / `2` from `25.5.1.2782` to `25.9.7.56` |
...
| `shared_merge_tree_merge_coordinator_merges_prepare_count` | in v25.5.1.2782 | Yes | `100` from `25.5.1.2782` to `26.3.33.10001` / `auto` from `26.4.1.1141` to `latest` |
...
| `shared_merge_tree_replica_set_max_lifetime_seconds` | in v26.3.1.896 | Yes | `1800` from `26.4.1.1141` to `latest` / `300` from `26.3.1.896` to `26.3.33.10001` |
| `shared_merge_tree_try_fetch_part_in_memory_data_from_replicas` | in v25.1.1.4165 | Yes | `0` from `25.1.1.4165` to `latest` |
| `shared_merge_tree_try_fetch_part_in_memory_data_from_replicas_on_startup` | in v26.6.1.1193 | Yes | `0` from `26.6.1.1193` to `latest` |
| `shared_merge_tree_update_replica_flags_delay_ms` | in v25.8.1.5101 | Yes | `30000` from `25.8.1.5101` to `latest` |
| `shared_merge_tree_use_blobs_list_for_parts` | in v26.8.1.2041 | Yes | `0` from `26.8.1.2041` to `latest` |
| `shared_merge_tree_use_metadata_hints_cache` | in v25.1.1.4165 | Yes | `1` from `25.1.1.4165` to `latest` |
| `shared_merge_tree_use_outdated_parts_compact_format` | in v25.1.1.4165 | Yes | `0` from `25.1.1.4165` to `25.8.33.6` / `1` from `25.9.2.1` to `latest` |
...
| `shared_merge_tree_virtual_parts_partition_atomic_discovery` | in v26.7.1.1315 | Yes | `1` from `26.7.1.1315` to `latest` |
| `simultaneous_parts_removal_limit` | in v23.1.1.3077 | Yes | `0` from `23.1.1.3077` to `latest` |
| `skip_empty_columns_on_insert` | in v26.9.1.1629 | Yes | `0` from `26.9.1.1629` to `latest` |
...
| `string_serialization_version` | in v25.10.1.3832 | Yes | `single_stream` from `25.10.1.3832` to `25.10.7.6` / `with_size_stream` from `25.11.1.558` to `latest` |
| `table_disk` | in v25.2.1.3085 | Yes | `0` from `25.2.1.3085` to `latest` |
| `table_readonly` | in v26.3.1.896 | Yes | `0` from `26.3.1.896` to `latest` |
| `temporary_directories_lifetime` | in v18.10.3 | Yes | `86400` from `18.10.3.0` to `latest` |
| `text_index_dictionary_block_frontcoding_compression` | in v26.6.1.1193 | Yes | `1` from `26.6.1.1193` to `latest` |
| `text_index_dictionary_block_size` | in v26.6.1.1193 | Yes | `512` from `26.6.1.1193` to `latest` |
| `text_index_max_memory_usage_before_flush` | in v26.8.1.2041 | Yes | `1073741824` from `26.8.1.2041` to `latest` |
| `text_index_max_processed_tokens_before_flush` | in v26.8.1.2041 | Yes | `100000000` from `26.8.1.2041` to `latest` |
| `text_index_posting_list_block_size` | in v26.6.1.1193 | Yes | `1048576` from `26.6.1.1193` to `latest` |
| `text_index_posting_list_codec` | in v26.6.1.1193 | Yes | `none` from `26.6.1.1193` to `latest` |
| `text_index_serialization_version` | in v26.6.4.55 | Yes | `v1_with_codec` from `26.6.4.55` to `26.7.13.12` / `v2_with_positions` from `26.8.1.2041` to `latest` |
...
| `vertical_merge_optimize_ttl_delete` | in v26.3.1.896 | Yes | `1` from `26.3.1.896` to `latest` |
...
| `write_marks_for_substreams_in_compact_parts` | in v25.5.1.2782 | Yes | `0` from `25.5.1.2782` to `25.8.28.10001` / `1` from `25.8.1.5101` to `latest` |
