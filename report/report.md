...
Generated at 2023-03-07 11:57:54 (America/Sao_Paulo), covering ClickHouse versions from 1.1.54019 to 23.2.3.17
...
| Engine | Introduced | Still Available? |
|:-|:-|:-|
| `MeiliSearch` | in v22.5.1.2079 | up to v22.8.14.53 |
...
| `JSONStringEachRow` | (unavailable) | (unavailable) | in v21.1.2.15 | up to v22.8.14.53 |
...
| `accurate_Cast` | No | No | (none) | in v21.9.2.17 | up to v22.8.14.53 |
| `accurate_CastOrNull` | No | No | (none) | in v21.9.2.17 | up to v22.8.14.53 |
...
| `date_trunc` | No | Yes | (none) | in v20.8.2.3 | up to v22.8.14.53 |
...
| `modelEvaluate` | No | No | (none) | in v1.1.54310 | up to v22.8.14.53 |
...
| `filesystem_cache_max_wait_sec` | in v22.4.1.2305 |  | up to v22.8.14.53 | Allow to wait at most this number of seconds for download of current remote_fs_buffer_size bytes, and skip cache if exceeded |
...
| `max_part_loading_threads` | in v19.14.3.3 | Yes | `\\auto(12)\\` from `22.10.7.13` to `latest` / `\\auto(4)\\` from `20.7.2.30` to `22.9.7.34` / `\\auto(6)\\` from `22.3.18.37` to `22.8.14.53` / `\\auto(8)\\` from `22.10.1.1877` to `22.12.3.5` / `auto(4)` from `19.14.3.3` to `20.6.11.1` |
| `max_part_removal_threads` | in v19.14.3.3 | Yes | `\\auto(12)\\` from `22.10.7.13` to `latest` / `\\auto(4)\\` from `20.7.2.30` to `22.9.7.34` / `\\auto(6)\\` from `22.3.18.37` to `22.8.14.53` / `\\auto(8)\\` from `22.10.1.1877` to `22.12.3.5` / `auto(4)` from `19.14.3.3` to `20.6.11.1` |
